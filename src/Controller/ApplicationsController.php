...
class ApplicationsController extends AppController
{
    ...
    public function index()
    {
        ...
        $query = $this->Applications
            ...
            ->where([['report_type' => 'Initial', 'approved' => 'Approved', 'status !=' =>  (!$this->request->getQuery('status')) ? 'UnSubmitted' : 'something_not']])
            ->distinct();
    ...
    public function view($id = null) {
        ...
        $application = $this->Applications->get($id, [
            'contain' => $contains,
            'conditions' => (['report_type' => 'Initial', 'submitted' => 2, 'approved' => 'Approved'])
        ]);
