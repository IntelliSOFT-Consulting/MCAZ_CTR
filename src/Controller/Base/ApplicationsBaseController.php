...
class ApplicationsBaseController extends AppController
{
    ...
    public function index()
    {
        ...
        if ($this->request->params['_ext'] === 'csv') {
            ...
            'single_site_member_state', 'location_of_area', 'single_site_physical_address', 'single_site_contact_person', 'single_site_telephone', 'multiple_sites_member_state', 'number_of_sites', 'single_site_name', 'single_site_physical_address', 'single_site_contact_details', 'single_site_contact_person', 'single_site_province_id', 
            ...
            function ($row) { return implode('|', Hash::extract($row['site_details'], '{n}.province_id')); }, 
