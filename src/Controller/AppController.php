...
class AppController extends Controller
{
    ...
    protected $a_contain = [
        'InvestigatorContacts', 'Participants', 'Sponsors', 'SiteDetails', 'Placebos',    'Medicines', 'Protocols', 'Attachments', 'Receipts', 'Registrations', 'Policies', 'Details', 'Proofs', 'Committees', 'Fees', 'Mc10Forms', 'LegalForms', 'CoverLetters', 'Leaflets', 'Brochures', 'InvestigatorCvs', 'Declarations', 'StudyMonitors', 'MonitoringPlans', 'PiDeclarations', 'StudySponsorships', 'PharmacyPlans', 'PharmacyLicenses', 'StudyMedicines', 'InsuranceCertificates', 'GenericInsurances', 'EthicsApprovals', 'EthicsLetters', 'CountryApprovals', 'Advertisments', 'SafetyMonitors', 'BiologicalProducts', 'Dossiers', 'FinanceAnnualApprovals', 'FinanceApprovals','FinanceApprovals.Users', 'FinanceApprovals.Attachments', 'AssignEvaluators', 'AssignEvaluators.Users', 'Evaluations', 'Evaluations.Users', 'Evaluations.EvaluationEdits', 'Evaluations.EvaluationEdits.Users','Quality',
        ...
        'EvaluationComments', 'EvaluationComments.Attachments', 'CommitteeComments', 'CommitteeComments.Attachments',  'CommitteeComments.Responses', 'CommitteeComments.Responses.Attachments', 'Clinicals', 'Clinicals.Users', 'NonClinicals', 'NonClinicals.Users', 'Statisticals', 'Statisticals.Users', 'QualityAssessments', 'QualityAssessments.Users','QualityAssessments.Sdrugs',
