...
class AppController extends Controller
{
    ...
    protected $a_contain = [
        ...
        'EvaluationComments', 'EvaluationComments.Attachments', 'CommitteeComments', 'CommitteeComments.Attachments',  'CommitteeComments.Responses', 'CommitteeComments.Responses.Attachments', 'Clinicals', 'NonClinicals', 'Statisticals', 'Qualities',
