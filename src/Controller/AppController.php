...
class AppController extends Controller
{
    ...
    'CommitteeReviews', 'CommitteeReviews.Comments', 'CommitteeReviews.Comments.Attachments', 
    'EvaluationComments', 'EvaluationComments.Attachments', 
    'DgReviews', 'DgReviews.Users', 'DgReviews.Attachments', 'FinalStages', 'FinalStages.Users', 'FinalStages.Attachments', 'EvaluationHeaders', 'RequestInfos', 'RequestInfos.Users', 'SeventyFives', 'GcpInspections', 'ParentApplications', 'ApplicationStages'];
    ...
    {
        parent::initialize();
        $this->_contain = ['PreviousDates', 'InvestigatorContacts', 'Participants', 'Sponsors', 'SiteDetails', 'Placebos', 'Medicines', 'Protocols', 'Attachments', 'Receipts', 'Registrations', 'Policies', 'Proofs', 'Committees', 'Fees', 'Mc10Forms', 'LegalForms', 'CoverLetters', 'Leaflets', 'Brochures', 'InvestigatorCvs', 'Declarations', 'StudyMonitors', 'MonitoringPlans', 'PiDeclarations', 'StudySponsorships', 'PharmacyPlans', 'PharmacyLicenses', 'StudyMedicines', 'InsuranceCertificates', 'GenericInsurances', 'EthicsApprovals', 'EthicsLetters', 'CountryApprovals', 'Advertisments', 'SafetyMonitors', 'BiologicalProducts', 'Dossiers', 'FinanceApprovals', 'FinanceApprovals.Attachments', 'AssignEvaluators', 'ApplicationStages', 'Amendments', 'Amendments.InvestigatorContacts', 'Amendments.Participants', 'Amendments.SiteDetails', 'Amendments.Medicines', 'Amendments.Registrations', 'Amendments.Policies',  'Amendments.Proofs', 'Amendments.Committees', 'Amendments.CoverLetters', 'Amendments.Fees', 'Amendments.LegalForms', 'Amendments.Protocols', 'Amendments.Leaflets', 'Amendments.Brochures', 'Amendments.InvestigatorCvs', 'Amendments.Declarations', 'Amendments.StudyMonitors', 'Amendments.MonitoringPlans', 'Amendments.PiDeclarations', 'Amendments.PharmacyPlans', 'Amendments.StudySponsorships', 'Amendments.PharmacyLicenses', 'Amendments.StudyMedicines', 'Amendments.InsuranceCertificates', 'Amendments.GenericInsurances', 'Amendments.EthicsApprovals', 'Amendments.EthicsLetters', 'Amendments.CountryApprovals', 'Amendments.Advertisments', 'Amendments.SafetyMonitors', 'Amendments.BiologicalProducts', 'Amendments.Dossiers', 'Amendments.Mc10Forms', 'Amendments.Receipts', 'Amendments.Attachments', 'Evaluations', 'CommitteeReviews', 'CommitteeReviews.Comments', 'CommitteeReviews.Comments.Attachments', 
        'EvaluationComments', 'EvaluationComments.Attachments', 
        'DgReviews', 'DgReviews.Users', 'DgReviews.Attachments', 'FinalStages', 'FinalStages.Users', 'FinalStages.Attachments', 'EvaluationHeaders', 'RequestInfos', 'RequestInfos.Users', 'SeventyFives', 'SeventyFives.Users', 'GcpInspections', 'GcpInspections.Users',];
