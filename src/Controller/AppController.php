...
class AppController extends Controller
{
    ...
    protected $a_contain = ['InvestigatorContacts', 'Participants', 'Sponsors', 'SiteDetails', 'Placebos',    'Medicines', 'Protocols', 'Attachments', 'Receipts', 'Registrations', 'Policies', 'Details', 'Proofs', 'Committees', 'Fees', 'Mc10Forms', 'LegalForms', 'CoverLetters', 'Leaflets', 'Brochures', 'InvestigatorCvs', 'Declarations', 'StudyMonitors', 'MonitoringPlans', 'PiDeclarations', 'StudySponsorships', 'PharmacyPlans', 'PharmacyLicenses', 'StudyMedicines', 'InsuranceCertificates', 'GenericInsurances', 'EthicsApprovals', 'EthicsLetters', 'CountryApprovals', 'Advertisments', 'SafetyMonitors', 'BiologicalProducts', 'Dossiers', 'FinanceAnnualApprovals', 'FinanceApprovals', 'FinanceApprovals.Attachments', 'AssignEvaluators', 'Evaluations', 'Evaluations.Users', 
    'CommitteeReviews', 'CommitteeReviews.Attachments', 'CommitteeReviews.Comments', 'CommitteeReviews.Comments.Attachments', 'Appeals', 'Appeals.Attachments', 'Appeals.Users',
