<?php
  ...
  <ul class="nav nav-sidebar nav-<?= $prefix ?>">
      ...
      <?= $this->Html->link('<i class="fa fa-file" aria-hidden="true"></i> &nbsp; PROTOCOLS', ['controller' => 'Applications', 'action' => 'index', 'prefix' => $prefix], array('escape' => false)); ?>
        ...
        <?php if (($prefix == 'manager' || $prefix == 'evaluator') && $this->request->params['controller'] == 'Applications' ) { ?>
          <ul class="nav van-<?= $prefix ?>">
            ...
            <li class="<?= (isset($this->request->query['status']) && $this->request->query['status'] == 'Finance') ? 'active' : ''; ?>"><?= $this->Html->link('<i class="fa fa-minus" aria-hidden="true"></i> Finance '.$Finance, ['controller' => 'Applications', 'action' => 'index', 'prefix' => $prefix, 'status' => 'Finance'], array('escape' => false)); ?> </li>
            ...
            <li class="<?= (isset($this->request->query['status']) && $this->request->query['status'] == 'Section75') ? 'active' : ''; ?>"><?= $this->Html->link('<i class="fa fa-minus" aria-hidden="true"></i> Section 75 '. $Section75 , ['controller' => 'Applications', 'action' => 'index', 'prefix' => $prefix, 'status' => 'Section75'], array('escape' => false)); ?> </li>
            <li class="<?= (isset($this->request->query['status']) && $this->request->query['status'] == 'GCP') ? 'active' : ''; ?>"><?= $this->Html->link('<i class="fa fa-minus" aria-hidden="true"></i> GCP Inspection '. $GCP , ['controller' => 'Applications', 'action' => 'index', 'prefix' => $prefix, 'status' => 'GCP'], array('escape' => false)); ?> </li>
            <li class="<?= (isset($this->request->query['status']) && $this->request->query['status'] == 'Notification') ? 'active' : ''; ?>"><?= $this->Html->link('<i class="fa fa-minus" aria-hidden="true"></i> Notification(s) '. $Notification , ['controller' => 'Applications', 'action' => 'index', 'prefix' => $prefix, 'status' => 'Notification'], array('escape' => false)); ?> </li>
    ...
    <li class="<?=  ($this->request->params['controller'] == 'Amendments') ? 'active' : ''; ?>">
      <?= $this->Html->link('<i class="fa fa-file-o" aria-hidden="true"></i> &nbsp; AMENDMENTS', ['controller' => 'Amendments', 'action' => 'index'], array('escape' => false)); ?>
        <!-- Manager or evaluator -->
        <?php if (($prefix == 'manager' || $prefix == 'evaluator') && $this->request->params['controller'] == 'Applications' ) { ?>
          <ul class="nav van-<?= $prefix ?>">
            <li class="<?= (isset($this->request->query['status']) && $this->request->query['status'] == 'Submitted') ? 'active' : ''; ?>"><?= $this->Html->link('<i class="fa fa-minus" aria-hidden="true"></i> Submitted '.$Submitted, ['controller' => 'Applications', 'action' => 'index', 'prefix' => $prefix, 'status' => 'Submitted'], array('escape' => false)); ?> </li>
