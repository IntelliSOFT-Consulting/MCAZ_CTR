    ...
    <table class="table table-striped table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php
                        echo $application->parent_application->protocol_no;
                      // echo ($application->submitted == 2) ? $this->Html->link($application->parent_application->protocol_no, ['action' => 'view', $application->id, 'prefix' => $prefix, 'status' => $application->status], ['escape' => false, 'class' => 'btn-zangu']) : $application->created ; ?></td>
