...
<div class="col-xs-10">
    ...
    ?>
            ...
            <a href="#" data-target="#modifyModal" data-toggle="modal" class="btn btn-warning"><i class="fa fa-cog"
                    aria-hidden="true"></i> Modify Reference Number </a>
            <?php }
    ?>
    ...
    ?>
            <a href="#" data-target="#reinstateModal" data-toggle="modal" class="btn btn-success active"><i
                    class="fa fa-thumbs-o-up" aria-hidden="true"></i> Reinstate Study </a>
            <?php
        ...
        ?>
            <a href="#" data-target="#suspendModal" data-toggle="modal" class="btn btn-warning"><i
                    class="fa fa-hand-paper-o" aria-hidden="true"></i> Suspend Study </a>
            <?php
      }
    }
    ?>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form method="post" accept-charset="utf-8"
                            action="/base/applications-base/update-reference/<?= $application->id ?>">
            ...
            <div class="modal fade" id="suspendModal" tabindex="-1" role="dialog" aria-labelledby="suspendModal">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form method="post" accept-charset="utf-8"
                            action="/base/applications-base/suspend/<?= $application->id ?>">
                            <div class="modal-body">
            ...
            <div class="modal fade" id="reinstateModal" tabindex="-1" role="dialog" aria-labelledby="reinstateModal">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form method="post" accept-charset="utf-8"
                            action="/base/applications-base/reinstate/<?= $application->id ?>">
                            <div class="modal-body">
...
<div class="col-xs-2">
    ...
    <ul class="nav nav-tabs nav-<?= $prefix ?> tabs-right" data-spy="affix" data-offset-top="60" role="tablist"
        id="myTab">
        <li role="presentation" class="active"><a href="#report" aria-controls="report" role="tab" data-toggle="tab">
                <b><?= ($application->submitted == 2) ? $application->protocol_no : $application->created ?></b></a>
        </li>
        <?php if($application->submitted == 2) { ?>
        <!-- Start Restriction -->
        <!-- check if manager or assigned evaluator -->
        ...
        <li role="presentation"><a href="#finance" aria-controls="finance" role="tab"
                data-toggle="tab"><b>Finance</b></a></li>
        <?php } ?>
        <?php if(in_array("Fees Complete", Hash::extract($application->finance_approvals, '{n}.outcome'))) { ?>
        <?php if($prefix != 'external_evaluator') { ?>
        <li role="presentation"><a href="#notification" aria-controls="notification" role="tab"
                data-toggle="tab"><b>Notifications</b></a></li>
        <?php } ?>
        <li role="presentation"><a href="#section75" aria-controls="section75" role="tab" data-toggle="tab"><b>Section
                    75</b></a></li>
        <?php if($prefix === 'manager' or $prefix === 'director_general') { ?>
        <?php if($prefix != 'external_evaluator') { ?>
        <li role="presentation"><a href="#assign" aria-controls="assign" role="tab" data-toggle="tab"><b>Assign
                    Evaluator(s)</b></a></li>
        <?php } ?>
        <?php } ?>
        <li role="presentation"><a href="#review" aria-controls="review" role="tab" data-toggle="tab"><b>Reviews</b></a>
        </li>
        <?php if($prefix != 'external_evaluator') { ?>
        <li role="presentation"><a href="#request" aria-controls="request" role="tab"
                data-toggle="tab"><b>Communications</b></a></li>
        <li role="presentation"><a href="#committee_feedback" aria-controls="committee_feedback" role="tab"
                data-toggle="tab"><b>Committee Feedback</b></a></li>
        <li role="presentation"><a href="#committee" aria-controls="committee" role="tab" data-toggle="tab"><b>Committee
                    Decision</b></a></li>
        <?php if($prefix === 'manager' or $prefix === 'director_general') { ?>
        <li role="presentation"><a href="#dg" aria-controls="dg" role="tab" data-toggle="tab"><b>Director
                    General</b></a></li>
        <?php } ?>
        ...
        <?php if($application->approved === 'Authorize') { ?>
        <li role="presentation"><a href="#sites" aria-controls="sites" role="tab" data-toggle="tab"><b>Sites
                    Management</b></a></li>
        <li role="presentation"><a href="#final" aria-controls="final" role="tab" data-toggle="tab"><b>Final
                    Stage</b></a></li>
        <?php } ?>
        <?php } }?>
        ...
        <!-- End of Restriction -->
        <?php } ?>
        <li role="presentation"><a href="#stages" aria-controls="stages" role="tab" data-toggle="tab"><b>STAGES</b></a>
        </li>
        <?php if($application->approved === 'Declined' || $application->approved === 'Suspended') { ?>
        <li role="presentation"><a href="#appeals" aria-controls="appeals" role="tab"
                data-toggle="tab"><b>Appeals</b></a></li>
        <?php } ?>
    </ul>
</div>
