 ...
 <body>
    ...
    <div id="navbar" class="navbar-collapse collapse">
      <ul class="nav navbar-nav">
        ...
        <li class="<?php echo $this->fetch('Applications') ?>">
            <?= $this->Html->link('<i class="fa fa-list"></i> Applications', 
                ['controller' => 'Applications', 'action' =>  'index', 'prefix' => false] , ['escape' => false]); ?>
        </li>
    ...
    <div class="jumbotron">
      <div class="container">
        ...
        <p class="lead" style="margin-bottom:10px; font-size:19px;">Public Clinical Trials Registry</p>
