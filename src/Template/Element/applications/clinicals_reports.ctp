        ...
        foreach ($clinicals as $clinical) {
            if ($clinical->evaluation_type == 'Initial') {
                ...
                <div class="thumbnail amend-form">
                    <a class="btn btn-primary" role="button" data-toggle="collapse" href="#<?= $clinical->created->i18nFormat('dd-MM-yyyy_HH_mm_ss') ?>" aria-expanded="false" aria-controls="<?= $clinical->created->i18nFormat('dd-MM-yyyy_HH_mm_ss') ?>">
                ...
                <div class="<?= ($this->request->params['_ext'] != 'pdf') ? 'collapse' : ''; ?>" id="<?= $clinical->created->i18nFormat('dd-MM-yyyy_HH_mm_ss') ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-7">
                                                    <p class="form-control-static text-info text-left">
                                                        <?php
                                                        echo $this->Html->link($clinical->file, substr($clinical->dir, 8) . '/' . $clinical->file, ['fullBase' => true]);
                                                        ?></p>
                                                </div>
                                            </div>
