      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="ctr-groups">
            <p class="topper"><small><em class="text-success">reviewed on: <?= $fina_stage['created'] ?> by <?= $fina_stage->user->name ?></em></small></p>
        <?php
              ...
              <div class="amend-form">
                <form class="form-horizontal">
                  <div class="form-group">
                    ...
                    <div class="col-xs-8">
                      <p class="form-control-static"><?= $fina_stage->internal_review_comment ?></p>
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-xs-8">
                    <p class="form-control-static"><?= $fina_stage['decision'] ?></p>
                    </div> 
                  </div> 
                  <div class="form-group">
