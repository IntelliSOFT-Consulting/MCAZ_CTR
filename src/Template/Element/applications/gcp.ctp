...
<div class="row">
  <div class="col-xs-12">
    ...
    <hr>
    <?php
        echo $this->Html->link('<i class="fa fa-file-pdf-o" aria-hidden="true"></i> Download All ', ['controller' => 'Applications', 'action' => 'gcp', '_ext' => 'pdf', $application->id, 'All', 'prefix' => 'base'], ['escape' => false, 'class' => 'btn btn-info btn-sm']);
              ?>
    ...
    <div class="ctr-groups <?php if($gcp_inspection->user->group_id != 4) echo 'amend-form'; ?>">
        ...
        <?php
        echo $this->Html->link('<i class="fa fa-file-pdf-o" aria-hidden="true"></i> Download PDF ', ['controller' => 'Applications', 'action' => 'gcp', '_ext' => 'pdf', $gcp_inspection->id, 'prefix' => 'base'], ['escape' => false, 'class' => 'btn btn-xs btn-success active topright']);
        ?>
