      ...
      ?>
            <div id="tabs-1">
                <table class="table table-condensed vertical-table">
                    <tr>
                        ...
                        <td <?php if($prefix == 'applicant') { ?> id="public-title" data-type="wysihtml5"
                            ...
                            data-name="public_title" data-title="Update public title" <?php } ?>>
              ...
              foreach($application['amendments'] as $key => $amendment) {
                if($amendment['submitted'] == 2 && !empty($amendment['public_title'])){      ?>
                    ...
                    <tr>
                        ...
                        <td <?php if($prefix == 'applicant') { ?> id="scientific-title" data-type="wysihtml5"
                            data-pk="<?= $application->id ?>"
                            data-url="<?= $this->Url->build(['controller' => 'Applications', 'action' => 'approvalEdit',  'prefix' => 'applicant', $application->id, '_ext' => 'json']); ?>"
                            data-name="scientific_title" data-title="Update scientific title" <?php } ?>>
                            <span><?= $application->scientific_title ?></span></td>
                    </tr>
                    <?php
              foreach($application['amendments'] as $key => $amendment) {
                if($amendment['submitted'] == 2 && !empty($amendment['scientific_title'])){      ?>
                    ...
                    <tr>
                        ...
                        <td <?php if($prefix == 'applicant') { ?> id="public-contact-name" data-type="text"
                            data-pk="<?= $application->id ?>"
                            data-url="<?= $this->Url->build(['controller' => 'Applications', 'action' => 'approvalEdit',  'prefix' => 'applicant', $application->id, '_ext' => 'json']); ?>"
                            data-name="public_contact_name" data-title="Update public name" <?php } ?>>
                            <span><?= $application->public_contact_name ?></span></td>
                    </tr>
                    <?php
              foreach($application['amendments'] as $key => $amendment) {
                if($amendment['submitted'] == 2 && !empty($amendment['public_contact_name'])){      ?>
                    ...
                    <tr>
                        ...
                        <td <?php if($prefix == 'applicant') { ?> id="public-contact-designation" data-type="text"
                            data-pk="<?= $application->id ?>"
                            data-url="<?= $this->Url->build(['controller' => 'Applications', 'action' => 'approvalEdit',  'prefix' => 'applicant', $application->id, '_ext' => 'json']); ?>"
                            data-name="public_contact_designation" data-title="Update public designation" <?php } ?>>
                            <span><?= $application->public_contact_designation ?></span></td>
                    </tr>
                    <?php
              foreach($application['amendments'] as $key => $amendment) {
                if($amendment['submitted'] == 2 && !empty($amendment['public_contact_designation'])){      ?>
                    ...
                    <tr>
                        ...
                        <td <?php if($prefix == 'applicant') { ?> id="public-contact-email" data-type="text"
                            data-pk="<?= $application->id ?>"
                            data-url="<?= $this->Url->build(['controller' => 'Applications', 'action' => 'approvalEdit',  'prefix' => 'applicant', $application->id, '_ext' => 'json']); ?>"
                            data-name="public_contact_email" data-title="Update public email" <?php } ?>>
                            <span><?= $application->public_contact_email ?></span></td>
                    </tr>
                    <?php
              foreach($application['amendments'] as $key => $amendment) {
                if($amendment['submitted'] == 2 && !empty($amendment['public_contact_email'])){      ?>
                    ...
                    <tr>
                        ...
                        <td <?php if($prefix == 'applicant') { ?> id="public-contact-phone" data-type="text"
                            data-pk="<?= $application->id ?>"
                            data-url="<?= $this->Url->build(['controller' => 'Applications', 'action' => 'approvalEdit',  'prefix' => 'applicant', $application->id, '_ext' => 'json']); ?>"
                            data-name="public_contact_phone" data-title="Update public phone" <?php } ?>>
              ...
              foreach($application['amendments'] as $key => $amendment) {
                if($amendment['submitted'] == 2 && !empty($amendment['public_contact_phone'])){      ?>
                    ...
                    <tr>
                        ...
                        <td <?php if($prefix == 'applicant') { ?> id="public-contact-postal" data-type="text"
                            data-pk="<?= $application->id ?>"
                            data-url="<?= $this->Url->build(['controller' => 'Applications', 'action' => 'approvalEdit',  'prefix' => 'applicant', $application->id, '_ext' => 'json']); ?>"
                            data-name="public_contact_postal" data-title="Update public postal" <?php } ?>>
              ...
              foreach($application['amendments'] as $key => $amendment) {
                if($amendment['submitted'] == 2 && !empty($amendment['public_contact_postal'])){      ?>
                    ...
                    <tr>
                        ...
                        <td <?php if($prefix == 'applicant') { ?> id="public-contact-affiliation" data-type="text"
                            data-pk="<?= $application->id ?>"
                            data-url="<?= $this->Url->build(['controller' => 'Applications', 'action' => 'approvalEdit',  'prefix' => 'applicant', $application->id, '_ext' => 'json']); ?>"
                            data-name="public_contact_affiliation" data-title="Update public title" <?php } ?>>
              ...
              foreach($application['amendments'] as $key => $amendment) {
                if($amendment['submitted'] == 2 && !empty($amendment['public_contact_affiliation'])){      ?>
                    ...
                    <tr>
                        ...
                        <td <?php if($prefix == 'applicant') { ?> id="scientific-contact-name" data-type="text"
                            data-pk="<?= $application->id ?>"
                            data-url="<?= $this->Url->build(['controller' => 'Applications', 'action' => 'approvalEdit',  'prefix' => 'applicant', $application->id, '_ext' => 'json']); ?>"
                            data-name="scientific_contact_name" data-title="Update scientific contact name" <?php } ?>>
              ...
              foreach($application['amendments'] as $key => $amendment) {
                if($amendment['submitted'] == 2 && !empty($amendment['scientific_contact_name'])){      ?>
                    ...
                    <tr>
                        ...
                        <td <?php if($prefix == 'applicant') { ?> id="scientific-contact-designation" data-type="text"
                            data-pk="<?= $application->id ?>"
                            data-url="<?= $this->Url->build(['controller' => 'Applications', 'action' => 'approvalEdit',  'prefix' => 'applicant', $application->id, '_ext' => 'json']); ?>"
                            data-name="scientific_contact_designation" data-title="Update scientific designation"
                            <?php } ?>><?= $application->scientific_contact_designation ?></td>
                    </tr>
                    <?php
              foreach($application['amendments'] as $key => $amendment) {
                if($amendment['submitted'] == 2 && !empty($amendment['scientific_contact_designation'])){      ?>
                    ...
                    <tr>
                        ...
                        <td <?php if($prefix == 'applicant') { ?> id="scientific-contact-email" data-type="text"
                            data-pk="<?= $application->id ?>"
                            data-url="<?= $this->Url->build(['controller' => 'Applications', 'action' => 'approvalEdit',  'prefix' => 'applicant', $application->id, '_ext' => 'json']); ?>"
                            data-name="scientific_contact_email" data-title="Update scientific contact email"
                            <?php } ?>><?= $application->scientific_contact_email ?></td>
                    </tr>
                    <?php
              foreach($application['amendments'] as $key => $amendment) {
                if($amendment['submitted'] == 2 && !empty($amendment['scientific_contact_email'])){      ?>
                    ...
                    <tr>
                        ...
                        <td <?php if($prefix == 'applicant') { ?> id="scientific-contact-phone" data-type="text"
                            data-pk="<?= $application->id ?>"
                            data-url="<?= $this->Url->build(['controller' => 'Applications', 'action' => 'approvalEdit',  'prefix' => 'applicant', $application->id, '_ext' => 'json']); ?>"
                            data-name="scientific_contact_phone" data-title="Update scientific contact phone"
                            <?php } ?>><?= $application->scientific_contact_phone ?></td>
                    </tr>
                    <?php
              foreach($application['amendments'] as $key => $amendment) {
                if($amendment['submitted'] == 2 && !empty($amendment['scientific_contact_phone'])){      ?>
                    ...
                    <tr>
                        ...
                        <td <?php if($prefix == 'applicant') { ?> id="scientific-contact-postal" data-type="text"
                            data-pk="<?= $application->id ?>"
                            data-url="<?= $this->Url->build(['controller' => 'Applications', 'action' => 'approvalEdit',  'prefix' => 'applicant', $application->id, '_ext' => 'json']); ?>"
                            data-name="scientific_contact_postal" data-title="Update scientific_contact_postal"
              ...
              foreach($application['amendments'] as $key => $amendment) {
                if($amendment['submitted'] == 2 && !empty($amendment['scientific_contact_postal'])){      ?>
                    ...
                    <tr>
                        ...
                        <td <?php if($prefix == 'applicant') { ?> id="scientific-contact-affiliation" data-type="text"
                            data-pk="<?= $application->id ?>"
                            data-url="<?= $this->Url->build(['controller' => 'Applications', 'action' => 'approvalEdit',  'prefix' => 'applicant', $application->id, '_ext' => 'json']); ?>"
                            data-name="scientific_contact_affiliation"
                            data-title="Update scientific_contact_affiliation" <?php } ?>>
              ...
              foreach($application['amendments'] as $key => $amendment) {
                if($amendment['submitted'] == 2 && !empty($amendment['scientific_contact_affiliation'])){      ?>
                    ...
                    <?php   } } ?>
                    <tr>
                        <td colspan="2"><label>Countries of Recruitment <i class="sterix fa fa-asterisk"
                    ...
                    <tr>
                        <td colspan="2" <?php if($prefix == 'applicant') { ?> id="countries-recruitment"
                            ...
                            data-url="<?= $this->Url->build(['controller' => 'Applications', 'action' => 'approvalEdit',  'prefix' => 'applicant', $application->id, '_ext' => 'json']); ?>"
                            data-name="countries_recruitment" data-title="Update countries of recruitment" <?php } ?>>
              ...
              foreach($application['amendments'] as $key => $amendment) {
                if($amendment['submitted'] == 2 && !empty($amendment['countries_recruitment'])){      ?>
                    ...
                    <?php   } } ?>
                    <tr>
                        <td colspan="2"><label>Purpose and Reason for Trial <i class="sterix fa fa-asterisk"
                                    aria-hidden="true"></i></label></td>
                    </tr>
                    <tr>
                        <td colspan="2">
          ...
          ?>
                <table class="table table-condensed vertical-table">
                    ...
                    <tr class="amender amender<?= $key+1 ?>">
                        <th>
                            <?php echo $key+1; ?> &nbsp; <label>Professional address <span
                                    class="sterix">*</span></label>
                        </th>
          ...
          ?>
              ...
              foreach($application['amendments'] as $key => $amendment) {
                if($amendment['submitted'] == 2 && !empty($amendment['business_telephone'])){      ?>
                    ...
                    <tr>
                        <th>
                            <label>Position of applicant <i class="sterix fa fa-asterisk"
            ...
            <div id="tabs-3">
                <table class="table table-condensed vertical-table">
                    ...
                    <tr>
                        ...
                        <td <?php if($prefix == 'applicant') { ?> id="money-source" data-type="text"
                            data-pk="<?= $application->id ?>"
                            data-url="<?= $this->Url->build(['controller' => 'Applications', 'action' => 'approvalEdit',  'prefix' => 'applicant', $application->id, '_ext' => 'json']); ?>"
                            data-name="money_source" data-title="Update money source" <?php } ?>>
           ...
           ?>
            ...
            <div id="tabs-4">
                <table class="table table-condensed vertical-table">
                    ...
                    <tr>
                        <td colspan="2"><label>Participants Description <i class="sterix fa fa-asterisk"
                                    aria-hidden="true"> </i> <small class="muted">(e.g age group of persons/animals,
              ...
              foreach($application['amendments'] as $key => $amendment) {
                if($amendment['submitted'] == 2 && !empty($amendment['participants_description'])){      ?>
                    ...
                    <?php   } } ?>
                    <tr>
                        <th><label>Expected Number of participants in Zimbabwe <i class="sterix fa fa-asterisk"
                                    aria-hidden="true"></i></label></th>
              ...
              foreach($application['amendments'] as $key => $amendment) {
                if($amendment['submitted'] == 2 && !empty($amendment['total_enrolment_per_site'])){      ?>
                    ...
                    <?php   } } ?>
                    <tr>
                        <th><label>Total participants worldwide <i class="sterix fa fa-asterisk"
                                    aria-hidden="true"></i></label></th>
              ...
              foreach($application['amendments'] as $key => $amendment) {
                if($amendment['submitted'] == 2 && !empty($amendment['total_participants_worldwide'])){      ?>
                    ...
                    <?php   } } ?>
                    <tr>
                        <td colspan="2"><label>Justification <i class="sterix fa fa-asterisk"
                                    aria-hidden="true"></i></label></td>
                    </tr>
                    <tr>
                        <td colspan="2">
          ...
          ?>
            ...
            <div id="tabs-6">
                <table class="table table-condensed vertical-table">
                    ...
                    <tr>
                        ...
                        <td <?php if($prefix == 'applicant') { ?> id="drug-name" data-type="text"
                            data-pk="<?= $application->id ?>"
                            data-url="<?= $this->Url->build(['controller' => 'Applications', 'action' => 'approvalEdit',  'prefix' => 'applicant', $application->id, '_ext' => 'json']); ?>"
                            data-name="drug_name" data-title="Update medicine name" <?php } ?>>
              ...
              foreach($application['amendments'] as $key => $amendment) {
                if($amendment['submitted'] == 2 && !empty($amendment['drug_name'])){      ?>
                    ...
                    <?php   } } ?>
                    <tr>
                        <th><label>Quantity of medicine required <i class="sterix fa fa-asterisk"
                                    aria-hidden="true"></i></label></th>
                        <td <?php if($prefix == 'applicant') { ?> id="quantity-excemption" data-type="wysihtml5"
                            data-pk="<?= $application->id ?>"
                            data-url="<?= $this->Url->build(['controller' => 'Applications', 'action' => 'approvalEdit',  'prefix' => 'applicant', $application->id, '_ext' => 'json']); ?>"
                            data-name="quantity_excemption" data-title="Update quantity of medicine" <?php } ?>>
                ...
                if($amendment['submitted'] == 2 && !empty($amendment['quantity_excemption'])){      ?>
                    ...
                    <tr>
                        <td colspan="2"><label>State the chemical composition, graphic and empirical formulae, animal
                                ...
                                or animals or any other relevant information or supply reports if available <i
                                    class="sterix fa fa-asterisk" aria-hidden="true"></i></label></td>
                    </tr>
                    <tr>
                        <td colspan="2">
           ...
           ?>
                ...
                if($amendment['submitted'] == 2 && !empty($amendment['concurrent_medicine'])){      ?>
                    ...
                    <tr>
                        <td colspan="2"><label>State measures to be implemented to ensure the safe handling of medicines
                                and promote and control compliances with the prescribed instructions<i
                                    class="sterix fa fa-asterisk" aria-hidden="true"></i></label></td>
                    </tr>
                    <tr>
                        <td colspan="2">
            ...
            <div id="tabs-7">
                <table class="table table-condensed vertical-table">
                    <tr>
                        <td colspan="2"><label>7.0 PRINCIPAL INCLUSION CRITERIA <i class="sterix fa fa-asterisk"
                                    aria-hidden="true"></i></label></td>
                    </tr>
                    <tr>
                        <td colspan="2" <?php if($prefix == 'applicant') { ?> id="principal-inclusion-criteria"
                            data-type="wysihtml5" data-pk="<?= $application->id ?>"
                            data-url="<?= $this->Url->build(['controller' => 'Applications', 'action' => 'approvalEdit',  'prefix' => 'applicant', $application->id, '_ext' => 'json']); ?>"
                            data-name="principal_inclusion_criteria" data-title="Update principal_inclusion_criteria"
                            <?php } ?>>
              ...
              foreach($application['amendments'] as $key => $amendment) {
                if($amendment['submitted'] == 2 && !empty($amendment['principal_inclusion_criteria'])){      ?>
                    ...
                    <?php   } } ?>
                    <tr>
                        <td colspan="2"><label>7.1 PRINCIPAL EXCLUSION CRITERIA <i class="sterix fa fa-asterisk"
                                    aria-hidden="true"></i></label></td>
                    </tr>
                    <tr>
                        <td colspan="2" <?php if($prefix == 'applicant') { ?> id="principal-exclusion-criteria"
                            data-type="wysihtml5" data-pk="<?= $application->id ?>"
                            data-url="<?= $this->Url->build(['controller' => 'Applications', 'action' => 'approvalEdit',  'prefix' => 'applicant', $application->id, '_ext' => 'json']); ?>"
                            data-name="principal_exclusion_criteria" data-title="Update principal_exclusion_criteria"
                            <?php } ?>>
              ...
              foreach($application['amendments'] as $key => $amendment) {
                if($amendment['submitted'] == 2 && !empty($amendment['principal_exclusion_criteria'])){      ?>
                    ...
                    <?php   } } ?>
                    <tr>
                        <td colspan="2"><label>7.2 PRIMARY END POINTS <i class="sterix fa fa-asterisk"
                                    aria-hidden="true"></i></label></td>
                    </tr>
                    <tr>
                        <td colspan="2" <?php if($prefix == 'applicant') { ?> id="primary-end-points"
                            data-type="wysihtml5" data-pk="<?= $application->id ?>"
                            data-url="<?= $this->Url->build(['controller' => 'Applications', 'action' => 'approvalEdit',  'prefix' => 'applicant', $application->id, '_ext' => 'json']); ?>"
                            data-name="primary_end_points" data-title="Update primary_end_points" <?php } ?>>
                    ...
                    <tr>
                        <td colspan="2">
                            <h5>8.0 SCOPE OF THE TRIAL - <i class="sterix fa fa-asterisk" aria-hidden="true"></i>
                                <small>Tick all boxes where applicable</small></h5>
                        </td>
                    </tr>

                    <tr>
                        <th><label>Health Condition(s) or Problem(s) Studied <i class="sterix fa fa-asterisk"
                                    aria-hidden="true"></i></label></th>
                        <td <?php if($prefix == 'applicant') { ?> id="disease-condition" data-type="wysihtml5"
                            data-pk="<?= $application->id ?>"
                            data-url="<?= $this->Url->build(['controller' => 'Applications', 'action' => 'approvalEdit',  'prefix' => 'applicant', $application->id, '_ext' => 'json']); ?>"
                            data-name="disease_condition" data-title="Update health condition" <?php } ?>>
                    ...
                    <tr>
                        <td colspan="2">
                            <label><?= ($application->trial_administration_humans) ? $checked : $nChecked; ?> First
                                administration to humans</label></td>
                    </tr>
                    <?php   } ?>
                    <?php
              foreach($application['amendments'] as $key => $amendment) {
                    ...
                    <tr>
                        <td colspan="2">
                            <label><?= ($application->trial_therapeutic_exploratory) ? $checked : $nChecked; ?>
                                Therapeutic exploratory (Phase II)</label></td>
                    </tr>
                    <?php
              foreach($application['amendments'] as $key => $amendment) {
                    ...
                    <tr>
                        <td colspan="2">
                            <label><?= ($application->trial_therapeutic_confirmatory) ? $checked : $nChecked; ?>
                                Therapeutic confirmatory (Phase III)</label></td>
                    </tr>
                    <?php
              foreach($application['amendments'] as $key => $amendment) {
           ...
           ?>
            ...
            <div id="tabs-11">
                <table class="table table-condensed vertical-table">
                    ...
                    <tr>
                        <th><label>11.1 State the time period for the trial <i class="sterix fa fa-asterisk"
                                    aria-hidden="true"></i> </label></th>
                    ...
                    <tr>
                        <td colspan="2">
                            <h5> 11.2 If the trial is to be conducted in Zimbabwe and not in the host country of the
                                applicant / sponsor, provide an explanation <i class="sterix fa fa-asterisk"
                    ...
                    <tr>
                        <td colspan="2">
                            <h5> 11.9 State the method of recording adverse reactions and provisions for dealing with
                                the same and other complications <i class="sterix fa fa-asterisk"
                                    aria-hidden="true"></i></h5>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2">
                            <h5> 11.10 State the procedure for keeping participants lists and participant records for
                                ...
                                (Attachment or records for identification of persons) <i class="sterix fa fa-asterisk"
                                    aria-hidden="true"></i></h5>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2">
                            <h5> 11.12 State measures to be implemented to ensure the safe handling of medicines and
                                promote and control compliances with prescribed instructions <i
                                    class="sterix fa fa-asterisk" aria-hidden="true"></i></h5>
                        </td>
                    </tr>
                    <tr>
              ...
              foreach($application['amendments'] as $key => $amendment) {
                if($amendment['submitted'] == 2 && !empty($amendment['evalution_of_results'])){      ?>
                    ...
                    <tr>
                        <td colspan="2">
                            <h5> 11.14 State how the persons or owners of animals are to be informed about the trial <i
                                    class="sterix fa fa-asterisk" aria-hidden="true"></i></h5>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <label>
                                ...
                                principal investigator or co-investigator <i class="sterix fa fa-asterisk"
                                    aria-hidden="true"></i>
                            </label>
                            <br>
                            <?php
                    ...
                    <tr>
                        ...
                        <td>
                            <label>
                                ...
                                declaration(s) by investigator(s) to comply with GCP <i class="sterix fa fa-asterisk"
                                    aria-hidden="true"></i>
                            </label>
                            <br>
                            <?php
                    ...
                    <tr>
                        ...
                        <td>
                            <label>
                                ...
                                plan by sponsor/PI/monitor throughout study <i class="sterix fa fa-asterisk"
                                    aria-hidden="true"></i>
                            </label>
                            <br>
                            <?php
                    ...
                    <tr>
                        ...
                        <td>
                            <label>
                                ...
                                Declaration by sponsor and national PI to comply with GCP <i
                                    class="sterix fa fa-asterisk" aria-hidden="true"></i>
                            </label>
                            <br>
                            <?php
