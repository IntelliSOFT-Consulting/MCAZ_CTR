        ...
        <div id="tabs">
            ...
            <div id="tabs-1">
                <table class="table table-condensed vertical-table">
                    <tr>
                        <th><label>PUBLIC TITLE/ACRONYM</label></th>
                        <td <?php if ($prefix == 'applicant') { ?> id="public-title" data-type="wysihtml5" data-pk="<?= $application->id ?>" data-url="<?= $this->Url->build(['controller' => 'Applications', 'action' => 'approvalEdit',  'prefix' => 'applicant', $application->id, '_ext' => 'json']); ?>" data-name="public_title" data-title="Update public title" <?php } ?>>
                            <p><?= $application->public_title ?></p>
                        </td>
                    </tr>
                    <?php
                    ...
                    <tr>
                        <th><label>Scientific Title</label></th>
                        <td <?php if ($prefix == 'applicant') { ?> id="scientific-title" data-type="wysihtml5" data-pk="<?= $application->id ?>" data-url="<?= $this->Url->build(['controller' => 'Applications', 'action' => 'approvalEdit',  'prefix' => 'applicant', $application->id, '_ext' => 'json']); ?>" data-name="scientific_title" data-title="Update scientific title" <?php } ?>>
                            <span><?= $application->scientific_title ?></span>
                        </td>
                    </tr>
                    <?php
                    foreach ($application['amendments'] as $key => $amendment) {
                    ...
                    <tr>
                        <td colspan="2"> <label>Contact for Public Queries</label> </td>
                    </tr>
                    <tr>
                        <th>
                            <label>Name <i class="sterix fa fa-asterisk" aria-hidden="true"></i></label>
                        </th>
                        <td <?php if ($prefix == 'applicant') { ?> id="public-contact-name" data-type="text" data-pk="<?= $application->id ?>" data-url="<?= $this->Url->build(['controller' => 'Applications', 'action' => 'approvalEdit',  'prefix' => 'applicant', $application->id, '_ext' => 'json']); ?>" data-name="public_contact_name" data-title="Update public name" <?php } ?>>
                            <span><?= $application->public_contact_name ?></span>
                        </td>
                    </tr>
                    <?php
                    foreach ($application['amendments'] as $key => $amendment) {
                    ...
                    <tr>
                        ...
                        <td <?php if ($prefix == 'applicant') { ?> id="public-contact-designation" data-type="text" data-pk="<?= $application->id ?>" data-url="<?= $this->Url->build(['controller' => 'Applications', 'action' => 'approvalEdit',  'prefix' => 'applicant', $application->id, '_ext' => 'json']); ?>" data-name="public_contact_designation" data-title="Update public designation" <?php } ?>>
                            <span><?= $application->public_contact_designation ?></span>
                        </td>
                    </tr>
                    <?php
                    foreach ($application['amendments'] as $key => $amendment) {
                    ...
                    <tr>
                        ...
                        <td <?php if ($prefix == 'applicant') { ?> id="public-contact-email" data-type="text" data-pk="<?= $application->id ?>" data-url="<?= $this->Url->build(['controller' => 'Applications', 'action' => 'approvalEdit',  'prefix' => 'applicant', $application->id, '_ext' => 'json']); ?>" data-name="public_contact_email" data-title="Update public email" <?php } ?>>
                            <span><?= $application->public_contact_email ?></span>
                        </td>
                    </tr>
                    <?php
                    foreach ($application['amendments'] as $key => $amendment) {
                    ...
                    <tr>
                        ...
                        <td <?php if ($prefix == 'applicant') { ?> id="public-contact-phone" data-type="text" data-pk="<?= $application->id ?>" data-url="<?= $this->Url->build(['controller' => 'Applications', 'action' => 'approvalEdit',  'prefix' => 'applicant', $application->id, '_ext' => 'json']); ?>" data-name="public_contact_phone" data-title="Update public phone" <?php } ?>>
                            <?= $application->public_contact_phone ?></td>
                    </tr>
                    <?php
                    foreach ($application['amendments'] as $key => $amendment) {
                    ...
                    <tr>
                        ...
                        <td <?php if ($prefix == 'applicant') { ?> id="public-contact-postal" data-type="text" data-pk="<?= $application->id ?>" data-url="<?= $this->Url->build(['controller' => 'Applications', 'action' => 'approvalEdit',  'prefix' => 'applicant', $application->id, '_ext' => 'json']); ?>" data-name="public_contact_postal" data-title="Update public postal" <?php } ?>>
                            <?= $application->public_contact_postal ?></td>
                    </tr>
                    <?php
                    foreach ($application['amendments'] as $key => $amendment) {
                    ...
                    <?php if (!empty($application->public_contact_affiliation)) { ?>
                        <tr>
                            ...
                            <td <?php if ($prefix == 'applicant') { ?> id="public-contact-affiliation" data-type="text" data-pk="<?= $application->id ?>" data-url="<?= $this->Url->build(['controller' => 'Applications', 'action' => 'approvalEdit',  'prefix' => 'applicant', $application->id, '_ext' => 'json']); ?>" data-name="public_contact_affiliation" data-title="Update public title" <?php } ?>>
                                <?= $application->public_contact_affiliation ?></td>
                        </tr>
                    <?php  } ?>
                    <?php
                    foreach ($application['amendments'] as $key => $amendment) {
                    ...
                    <tr>
                        <td colspan="2"> <label>Contact for Scientific Queries</label> </td>
                    </tr>
                    <tr>
                        <th>
                            <label>Name <i class="sterix fa fa-asterisk" aria-hidden="true"></i></label>
                        </th>
                        <td <?php if ($prefix == 'applicant') { ?> id="scientific-contact-name" data-type="text" data-pk="<?= $application->id ?>" data-url="<?= $this->Url->build(['controller' => 'Applications', 'action' => 'approvalEdit',  'prefix' => 'applicant', $application->id, '_ext' => 'json']); ?>" data-name="scientific_contact_name" data-title="Update scientific contact name" <?php } ?>>
                            <?= $application->scientific_contact_name ?></td>
                    </tr>
                    <?php
                    foreach ($application['amendments'] as $key => $amendment) {
                    ...
                    <tr>
                        ...
                        <td <?php if ($prefix == 'applicant') { ?> id="scientific-contact-designation" data-type="text" data-pk="<?= $application->id ?>" data-url="<?= $this->Url->build(['controller' => 'Applications', 'action' => 'approvalEdit',  'prefix' => 'applicant', $application->id, '_ext' => 'json']); ?>" data-name="scientific_contact_designation" data-title="Update scientific designation" <?php } ?>><?= $application->scientific_contact_designation ?></td>
                    </tr>
                    <?php
                    foreach ($application['amendments'] as $key => $amendment) {
                    ...
                    <tr>
                        ...
                        <td <?php if ($prefix == 'applicant') { ?> id="scientific-contact-email" data-type="text" data-pk="<?= $application->id ?>" data-url="<?= $this->Url->build(['controller' => 'Applications', 'action' => 'approvalEdit',  'prefix' => 'applicant', $application->id, '_ext' => 'json']); ?>" data-name="scientific_contact_email" data-title="Update scientific contact email" <?php } ?>><?= $application->scientific_contact_email ?></td>
                    </tr>
                    <?php
                    foreach ($application['amendments'] as $key => $amendment) {
                    ...
                    <tr>
                        ...
                        <td <?php if ($prefix == 'applicant') { ?> id="scientific-contact-phone" data-type="text" data-pk="<?= $application->id ?>" data-url="<?= $this->Url->build(['controller' => 'Applications', 'action' => 'approvalEdit',  'prefix' => 'applicant', $application->id, '_ext' => 'json']); ?>" data-name="scientific_contact_phone" data-title="Update scientific contact phone" <?php } ?>><?= $application->scientific_contact_phone ?></td>
                    </tr>
                    <?php
                    foreach ($application['amendments'] as $key => $amendment) {
                    ...
                    <tr>
                        ...
                        <td <?php if ($prefix == 'applicant') { ?> id="scientific-contact-postal" data-type="text" data-pk="<?= $application->id ?>" data-url="<?= $this->Url->build(['controller' => 'Applications', 'action' => 'approvalEdit',  'prefix' => 'applicant', $application->id, '_ext' => 'json']); ?>" data-name="scientific_contact_postal" data-title="Update scientific_contact_postal" <?php } ?>><?= $application->scientific_contact_postal ?></td>
                    </tr>
                    <?php
                    foreach ($application['amendments'] as $key => $amendment) {
                    ...
                    <?php if (!empty($application->scientific_contact_affiliation)) { ?>
                        <tr>
                            ...
                            <td <?php if ($prefix == 'applicant') { ?> id="scientific-contact-affiliation" data-type="text" data-pk="<?= $application->id ?>" data-url="<?= $this->Url->build(['controller' => 'Applications', 'action' => 'approvalEdit',  'prefix' => 'applicant', $application->id, '_ext' => 'json']); ?>" data-name="scientific_contact_affiliation" data-title="Update scientific_contact_affiliation" <?php } ?>>
                                <?= $application->scientific_contact_affiliation ?></td>
                        </tr>
                    <?php   } ?>
                    <?php
                    foreach ($application['amendments'] as $key => $amendment) {
                    ...
                    <tr>
                        <td colspan="2" <?php if ($prefix == 'applicant') { ?> id="countries-recruitment" data-type="wysihtml5" data-pk="<?= $application->id ?>" data-url="<?= $this->Url->build(['controller' => 'Applications', 'action' => 'approvalEdit',  'prefix' => 'applicant', $application->id, '_ext' => 'json']); ?>" data-name="countries_recruitment" data-title="Update countries of recruitment" <?php } ?>>
                    ...
                    <tr>
                        <th> </th>
                        <td><label><?= ($application->product_type_chemical) ? $checked : $nChecked; ?> Chemical</label>
                        </td>
                    </tr>
                    <?php
                    foreach ($application['amendments'] as $key => $amendment) {
                    ...
                    <tr>
                        <th> </th>
                        <td><label><?= ($application->product_type_biologicals) ? $checked : $nChecked; ?>
                                Biological</label></td>
                    </tr>
                    <?php
                    foreach ($application['amendments'] as $key => $amendment) {
                    ...
                    <tr>
                        <th> </th>
                        <td><label><?= ($application->product_type_medical_device) ? $checked : $nChecked; ?> Medical
                                Device</label></td>
                    </tr>
                    <?php
                    foreach ($application['amendments'] as $key => $amendment) {
            ...
            <div id="tabs-2">
                ...
                <table class="table table-condensed vertical-table">
                    <?php if (!empty($application->business_name)) { ?>
                        <tr>
                            <td colspan="2"> <label>Business</label> </td>
                        </tr>
                        <tr>
                            <th>
            ...
            <div id="tabs-3">
                <table class="table table-condensed vertical-table">
                    ...
                    <tr>
                        ...
                        <td <?php if ($prefix == 'applicant') { ?> id="money-source" data-type="text" data-pk="<?= $application->id ?>" data-url="<?= $this->Url->build(['controller' => 'Applications', 'action' => 'approvalEdit',  'prefix' => 'applicant', $application->id, '_ext' => 'json']); ?>" data-name="money_source" data-title="Update money source" <?php } ?>>
                            <?= $application->money_source ?></td>
                    </tr>
                    <?php
                    foreach ($application['amendments'] as $key => $amendment) {
            ...
            <div id="tabs-4">
                <table class="table table-condensed vertical-table">
                    ...
                    <tr>
                        <td colspan="2"><label>Participants Description <i class="sterix fa fa-asterisk" aria-hidden="true"> </i> <small class="muted">(e.g age group of persons/animals,
                                    type or class of persons/animals, sex etc)</small></label></td>
                    </tr>
                    <tr>
                        <td colspan="2">
                    ...
                    <?php if (!empty($application->total_enrolment_per_site)) { ?>
                        <tr>
                            <th><label>Total enrolment in each site: (if competitive enrolment, state minimum and maximum
                                    number per site.) <i class="sterix fa fa-asterisk" aria-hidden="true"></i></label></th>
                    ...
                    <tr>
                        <th><label>Preterm Newborn Infants (up to gestational age < 37 weeks?</label>
                        </th>
                    ...
                    <tbody>
                        ...
                        ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p class="text-info text-left"><?php
                ...
                <table class="table table-condensed vertical-table">
                    ...
                    <?php if (!empty($application->single_site_province_id)) { ?>
                        <tr>
                            ...
                            <td><?= ($application->single_site_province_id) ? $provinces->toArray()[$application->single_site_province_id] : '' ?>
                            </td>
                        </tr>
                    <?php  } ?>
                    <?php
                    foreach ($application['amendments'] as $key => $amendment) {
                        if ($amendment['submitted'] == 2 && !empty($amendment['single_site_province_id'])) {      ?>
                            <tr class="amender amender<?= $key + 1 ?>">
                                <th><?php echo $key + 1; ?></th>
                                <td><?= ($amendment->single_site_province_id) ? $provinces->toArray()[$amendment->single_site_province_id] : '' ?>
                                </td>
                            </tr>
                    <?php   }
                    } ?>
                    ...
                    ?>
                            ...
                            <tr>
                                <th><label>Province</label></th>
                                <td><?= ($application->site_details[$i]['province_id']) ? $provinces->toArray()[$application->site_details[$i]['province_id']] : '' ?>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2"></td>
                    ...
                    ?>
                                ...
                                <tr class="amender amender<?= $key + 1 ?>">
                                    ...
                                    <td><?= ($amendment->site_details[$i]['province_id']) ? $provinces->toArray()[$amendment->site_details[$i]['province_id']] : '' ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2"></td>
            ...
            <div id="tabs-6">
                <table class="table table-condensed vertical-table">
                    ...
                    <tr>
                        ...
                        <td <?php if ($prefix == 'applicant') { ?> id="drug-name" data-type="text" data-pk="<?= $application->id ?>" data-url="<?= $this->Url->build(['controller' => 'Applications', 'action' => 'approvalEdit',  'prefix' => 'applicant', $application->id, '_ext' => 'json']); ?>" data-name="drug_name" data-title="Update medicine name" <?php } ?>>
                            <?= $application->drug_name ?></td>
                    </tr>
                    <?php
                    foreach ($application['amendments'] as $key => $amendment) {
                    ...
                    <tr>
                        ...
                        <td <?php if ($prefix == 'applicant') { ?> id="quantity-excemption" data-type="wysihtml5" data-pk="<?= $application->id ?>" data-url="<?= $this->Url->build(['controller' => 'Applications', 'action' => 'approvalEdit',  'prefix' => 'applicant', $application->id, '_ext' => 'json']); ?>" data-name="quantity_excemption" data-title="Update quantity of medicine" <?php } ?>>
                            <?= $application->quantity_excemption ?></td>
                    </tr>
                    <?php
                    foreach ($application['amendments'] as $key => $amendment) {
                    ...
                    <tr>
                        <td colspan="2"><label>State the chemical composition, graphic and empirical formulae, animal
                                pharmacology, toxicity and teratology as well as any clinical or field trials in humans
                                or animals or any other relevant information or supply reports if available <i class="sterix fa fa-asterisk" aria-hidden="true"></i></label></td>
                    </tr>
                    <tr>
                        <td colspan="2">
                    ...
                    <tr>
                        <td colspan="2"><label>If YES attach a valid certificate of registration in respect of such
                                medicine issued by the appropriate authority established for the registration of
                                medicine in the country of origin shall accompany this application</label></td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <?php
                    ...
                    foreach ($application['amendments'] as $key => $amendment) {
                        if ($amendment['submitted'] == 2 && !empty($amendment['registrations'])) {
                            for ($i = 0; $i <= count($amendment['registrations']) - 1; $i++) { ?>
                                <tr class="amender amender<?= $key + 1 ?>">
                                    <th><?php echo $key + 1; ?> </th>
                                    <td><?= $this->Html->link($amendment['registrations'][$i]->file, substr($amendment['registrations'][$i]->dir, 8) . '/' . $amendment['registrations'][$i]->file, ['fullBase' => true, 'class' => 'btn btn-info']) . " &nbsp;" ?>
                                    </td>
                                </tr>
                    <?php
                            }
                    ...
                    <tr>
                        <td colspan="2"><label>If Yes,State details/reason including the date on which the application
                                was lodged</label></td>
                    </tr>
                    <tr>
                        <td colspan="2">
                    ...
                    <tr>
                        <th><label>e) Has the registration of the medicine been rejected/deferred /cancelled in any
                                country?</label></th>
                    ...
                    <tr>
                        <td colspan="2"><label>State the quantity of the medicine for which exemption is required if the
                                medicine is not registered</label></td>
                    </tr>
                    <tr>
                        <td colspan="2">
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <h5 class="controls"><label>Other Medicines (<small>Repeat as necessary </small>)</label>
                            </h5>
                        </td>
                    </tr>
                    <?php
                    ...
                    <tr>
                        <td colspan="2"><label>Administration route, dosage, dosage interval and period for the medicine
                                being tested and the medicine being used as a control</label></td>
                    </tr>
                    <tr>
                        <td colspan="2">
                    ...
                    <tr>
                        <th><label>State whether the person already on another medicine will be given the experimential
                                medicine at the same time or will be taken off the medicine</label></th>
                    ...
                    <tr>
                        <td colspan="2"><label>State measures to be implemented to ensure the safe handling of medicines
                                and promote and control compliances with the prescribed instructions<i class="sterix fa fa-asterisk" aria-hidden="true"></i></label></td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <?= $application->safety ?>
            ...
            <div id="tabs-7">
                <table class="table table-condensed vertical-table">
                    ...
                    <tr>
                        <td colspan="2" <?php if ($prefix == 'applicant') { ?> id="principal-inclusion-criteria" data-type="wysihtml5" data-pk="<?= $application->id ?>" data-url="<?= $this->Url->build(['controller' => 'Applications', 'action' => 'approvalEdit',  'prefix' => 'applicant', $application->id, '_ext' => 'json']); ?>" data-name="principal_inclusion_criteria" data-title="Update principal_inclusion_criteria" <?php } ?>>
                    ...
                    <tr>
                        <td colspan="2" <?php if ($prefix == 'applicant') { ?> id="principal-exclusion-criteria" data-type="wysihtml5" data-pk="<?= $application->id ?>" data-url="<?= $this->Url->build(['controller' => 'Applications', 'action' => 'approvalEdit',  'prefix' => 'applicant', $application->id, '_ext' => 'json']); ?>" data-name="principal_exclusion_criteria" data-title="Update principal_exclusion_criteria" <?php } ?>>
                    ...
                    <tr>
                        <td colspan="2" <?php if ($prefix == 'applicant') { ?> id="primary-end-points" data-type="wysihtml5" data-pk="<?= $application->id ?>" data-url="<?= $this->Url->build(['controller' => 'Applications', 'action' => 'approvalEdit',  'prefix' => 'applicant', $application->id, '_ext' => 'json']); ?>" data-name="primary_end_points" data-title="Update primary_end_points" <?php } ?>>
            ...
            <div id="tabs-8">
                <table class="table table-condensed vertical-table">
                    <tr>
                        <td colspan="2">
                            <h5>8.0 SCOPE OF THE TRIAL - <i class="sterix fa fa-asterisk" aria-hidden="true"></i>
                                <small>Tick all boxes where applicable</small>
                            </h5>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td <?php if ($prefix == 'applicant') { ?> id="disease-condition" data-type="wysihtml5" data-pk="<?= $application->id ?>" data-url="<?= $this->Url->build(['controller' => 'Applications', 'action' => 'approvalEdit',  'prefix' => 'applicant', $application->id, '_ext' => 'json']); ?>" data-name="disease_condition" data-title="Update health condition" <?php } ?>>
                            <?= $application->disease_condition ?></td>
                    </tr>
                    <tr>
                        <td><label><?= ($application->scope_diagnosis) ? $checked : $nChecked; ?> Diagnosis</label></td>
                        <td><label><?= ($application->scope_bioequivalence) ? $checked : $nChecked; ?>
                                Bioequivalence</label></td>
                    </tr>
                    <?php
                    foreach ($application['amendments'] as $key => $amendment) {
                        if ($amendment['submitted'] == 2 && !empty($amendment['scope_diagnosis'])) {      ?>
                            ...
                            <tr>
                                <td colspan="2"><label><?= ($amendment->scope_diagnosis) ? $checked : $nChecked; ?>
                                        Diagnosis</label></td>
                            </tr>
                    <?php   }
                    } ?>
                    ...
                    foreach ($application['amendments'] as $key => $amendment) {
                        if ($amendment['submitted'] == 2 && !empty($amendment['scope_bioequivalence'])) {      ?>
                            ...
                            <tr>
                                <td colspan="2"><label><?= ($application->scope_bioequivalence) ? $checked : $nChecked; ?>
                                        Bioequivalence</label></td>
                            </tr>
                    <?php   }
                    } ?>
                    <tr>
                        <td><label><?= ($application->scope_prophylaxis) ? $checked : $nChecked; ?> Prophylaxis</label>
                        </td>
                        <td><label><?= ($application->scope_dose_response) ? $checked : $nChecked; ?> Dose
                                Response</label></td>
                    </tr>
                    <?php
                    foreach ($application['amendments'] as $key => $amendment) {
                        if ($amendment['submitted'] == 2 && !empty($amendment['scope_prophylaxis'])) {      ?>
                            ...
                            <tr>
                                <td colspan="2"><label><?= ($application->scope_prophylaxis) ? $checked : $nChecked; ?>
                    ...
                    foreach ($application['amendments'] as $key => $amendment) {
                        if ($amendment['submitted'] == 2 && !empty($amendment['scope_dose_response'])) {      ?>
                            ...
                            <tr>
                                <td colspan="2"><label><?= ($application->scope_dose_response) ? $checked : $nChecked; ?> Dose
                                        Response</label></td>
                            </tr>
                    <?php   }
                    } ?>
                    <tr>
                        ...
                        <td><label><?= ($application->scope_pharmacogenetic) ? $checked : $nChecked; ?>
                                Pharmacogenetic</label></td>
                    </tr>
                    <?php
                    foreach ($application['amendments'] as $key => $amendment) {
                        if ($amendment['submitted'] == 2 && !empty($amendment['scope_therapy'])) {      ?>
                            ...
                            <tr>
                                <td colspan="2"><label><?= ($application->scope_therapy) ? $checked : $nChecked; ?>
                                        Therapy</label></td>
                            </tr>
                    <?php   }
                    } ?>
                    ...
                    foreach ($application['amendments'] as $key => $amendment) {
                        if ($amendment['submitted'] == 2 && !empty($amendment['scope_pharmacogenetic'])) {      ?>
                            ...
                            <tr>
                                <td colspan="2"><label><?= ($application->scope_pharmacogenetic) ? $checked : $nChecked; ?>
                                        Pharmacogenetic</label></td>
                            </tr>
                    <?php   }
                    } ?>
                    <tr>
                        ...
                        <td><label><?= ($application->scope_pharmacogenomic) ? $checked : $nChecked; ?>
                                Pharmacogenomic</label></td>
                    </tr>
                    <?php
                    foreach ($application['amendments'] as $key => $amendment) {
                        if ($amendment['submitted'] == 2 && !empty($amendment['scope_safety'])) {      ?>
                            ...
                            <tr>
                                <td colspan="2"><label><?= ($application->scope_safety) ? $checked : $nChecked; ?>
                                        Safety</label></td>
                            </tr>
                    <?php   }
                    } ?>
                    ...
                    foreach ($application['amendments'] as $key => $amendment) {
                        if ($amendment['submitted'] == 2 && !empty($amendment['scope_pharmacogenomic'])) {      ?>
                            ...
                            <tr>
                                <td colspan="2"><label><?= ($application->scope_pharmacogenomic) ? $checked : $nChecked; ?>
                                        Pharmacogenomic</label></td>
                            </tr>
                    <?php   }
                    } ?>
                    <tr>
                        ...
                        <td><label><?= ($application->scope_pharmacoecomomic) ? $checked : $nChecked; ?>
                                Pharmacoecomomic</label></td>
                    </tr>
                    <?php
                    foreach ($application['amendments'] as $key => $amendment) {
                        if ($amendment['submitted'] == 2 && !empty($amendment['scope_efficacy'])) {      ?>
                            ...
                            <tr>
                                <td colspan="2"><label><?= ($application->scope_efficacy) ? $checked : $nChecked; ?>
                                        Efficacy</label></td>
                            </tr>
                    <?php   }
                    } ?>
                    ...
                    foreach ($application['amendments'] as $key => $amendment) {
                        if ($amendment['submitted'] == 2 && !empty($amendment['scope_pharmacoecomomic'])) {      ?>
                            ...
                            <tr>
                                <td colspan="2"><label><?= ($application->scope_pharmacoecomomic) ? $checked : $nChecked; ?>
                                        Pharmacoecomomic</label></td>
                            </tr>
                    <?php   }
                    } ?>
                    ...
                    <tr>
                        <td><label><?= ($application->scope_pharmacokinetic) ? $checked : $nChecked; ?>
                                Pharmacokinetic</label></td>
                        <td> </td>
                    </tr>
                    <?php
                    foreach ($application['amendments'] as $key => $amendment) {
                        if ($amendment['submitted'] == 2 && !empty($amendment['scope_pharmacokinetic'])) {      ?>
                            ...
                            <tr>
                                <td colspan="2"><label><?= ($application->scope_pharmacokinetic) ? $checked : $nChecked; ?>
                                        Pharmacokinetic</label></td>
                            </tr>
                    <?php   }
                    } ?>
                    <tr>
                        <td><label><?= ($application->scope_pharmacodynamic) ? $checked : $nChecked; ?>
                                Pharmacodynamic</label></td>
                        <td> </td>
                    </tr>
                    <?php
                    foreach ($application['amendments'] as $key => $amendment) {
                        if ($amendment['submitted'] == 2 && !empty($amendment['scope_pharmacodynamic'])) {      ?>
                            ...
                            <tr>
                                <td colspan="2"><label><?= ($application->scope_pharmacodynamic) ? $checked : $nChecked; ?>
                                        Pharmacodynamic</label></td>
                            </tr>
                    <?php   }
                    } ?>
                    ...
                    foreach ($application['amendments'] as $key => $amendment) {
                        if ($amendment['submitted'] == 2 && !empty($amendment['scope_others'])) {      ?>
                            ...
                            <tr>
                                <td colspan="2"><label><?= ($application->scope_others) ? $checked : $nChecked; ?>
                                        Others</label></td>
                            </tr>
                    <?php   }
                    } ?>
                    ...
                    <?php if (!empty($application->trial_human_pharmacology)) { ?>
                        <tr>
                            <td><label><?= ($application->trial_human_pharmacology) ? $checked : $nChecked; ?> Human
                                    pharmacology (Phase I)</label></td>
                            <td> </td>
                        </tr>
                    <?php  } ?>
                    <?php
                    foreach ($application['amendments'] as $key => $amendment) {
                        if ($amendment['submitted'] == 2 && !empty($amendment['trial_human_pharmacology'])) {      ?>
                            ...
                            <tr>
                                <td colspan="2"><label><?= ($application->trial_human_pharmacology) ? $checked : $nChecked; ?>
                                        Human pharmacology (Phase I)</label></td>
                            </tr>
                    <?php   }
                    } ?>
                    ...
                    <?php if (!empty($application->trial_administration_humans)) { ?>
                        <tr>
                            <td colspan="2">
                                <label><?= ($application->trial_administration_humans) ? $checked : $nChecked; ?> First
                                    administration to humans</label>
                            </td>
                        </tr>
                    <?php   } ?>
                    <?php
                    ...
                    <?php if (!empty($application->trial_bioequivalence_study)) { ?>
                        <tr>
                            <td colspan="2"><label><?= ($application->trial_bioequivalence_study) ? $checked : $nChecked; ?>
                                    Bioequivalence study</label></td>
                        </tr>
                    <?php  } ?>
                    <?php
                    foreach ($application['amendments'] as $key => $amendment) {
                    ...
                    <?php if (!empty($application->trial_other)) { ?>
                        <tr>
                            <td colspan="2"><label><?= ($application->trial_other) ? $checked : $nChecked; ?> Other</label>
                            </td>
                        </tr>
                    <?php  } ?>
                    <?php
                    ...
                    <?php if (!empty($application->trial_other_specify)) { ?>
                        <tr>
                            <td colspan="2"><label>If other, please specify:
                                    <?= $application->trial_other_specify ?></label></td>
                        </tr>
                    <?php   } ?>
                    <?php
                    foreach ($application['amendments'] as $key => $amendment) {
                        if ($amendment['submitted'] == 2 && !empty($amendment['trial_other_specify'])) {      ?>
                            ...
                            <tr>
                                <td colspan="2"><label>If other, please specify: <?= $application->trial_other_specify ?>
                                    </label></td>
                            </tr>
                    <?php   }
                    } ?>
                    <tr>
                        <td colspan="2">
                            <label><?= ($application->trial_therapeutic_exploratory) ? $checked : $nChecked; ?>
                                Therapeutic exploratory (Phase II)</label>
                        </td>
                    </tr>
                    <?php
                    foreach ($application['amendments'] as $key => $amendment) {
                    ...
                    <tr>
                        <td colspan="2">
                            <label><?= ($application->trial_therapeutic_confirmatory) ? $checked : $nChecked; ?>
                                Therapeutic confirmatory (Phase III)</label>
                        </td>
                    </tr>
                    <?php
                    foreach ($application['amendments'] as $key => $amendment) {
                    ...
                    <tr>
                        <td colspan="2"><label><?= ($application->trial_therapeutic_use) ? $checked : $nChecked; ?>
                                Therapeutic use (Phase IV)</label></td>
                    </tr>
                    <?php
                    foreach ($application['amendments'] as $key => $amendment) {
            ...
            <div id="tabs-10">
                <table class="table table-condensed vertical-table">
                    ...
                    <tr>
                        <td colspan="2"><label>State any ethical or moral considerations relating to the trial giving
                                details <i class="sterix fa fa-asterisk" aria-hidden="true"></i></label></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2"><label>Company who will insure the participants in the proposed trial</label>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2">
                            <label>(Allow attachment for a letter from the insurance company indicating company\'s
                                consent to the proposed insurance and a copy of the proposed insurance policy)</label>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                    ...
                    foreach ($application['amendments'] as $key => $amendment) {
                        if ($amendment['submitted'] == 2 && !empty($amendment['policies'])) {
                            for ($i = 0; $i <= count($amendment['policies']) - 1; $i++) { ?>
                                <tr class="amender amender<?= $key + 1 ?>">
                                    <th><?php echo $key + 1; ?> </th>
                                    <td><?= $this->Html->link($amendment['policies'][$i]->file, substr($amendment['policies'][$i]->dir, 8) . '/' . $amendment['policies'][$i]->file, ['fullBase' => true, 'class' => 'btn btn-info']) . " &nbsp;" ?>
                                    </td>
                                </tr>
                    <?php
                            }
                    ...
                    foreach ($application['amendments'] as $key => $amendment) {
                        if ($amendment['submitted'] == 2 && !empty($amendment['details'])) {
                            for ($i = 0; $i <= count($amendment['details']) - 1; $i++) { ?>
                                <tr class="amender amender<?= $key + 1 ?>">
                                    <th><?php echo $key + 1; ?> </th>
                                    <td><?= $this->Html->link($amendment['details'][$i]->file, substr($amendment['details'][$i]->dir, 8) . '/' . $amendment['details'][$i]->file, ['fullBase' => true, 'class' => 'btn btn-info']) . " &nbsp;" ?>
                                    </td>
                                </tr>
                    <?php
                            }
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <br />The Ethics review process of the trial record in the primary register database
                            comprises of:<br>
                        </td>
                    </tr>
                    <tr>
                    ...
                    foreach ($application['amendments'] as $key => $amendment) {
                        if ($amendment['submitted'] == 2 && !empty($amendment['proofs'])) {
                            for ($i = 0; $i <= count($amendment['proofs']) - 1; $i++) { ?>
                                <tr class="amender amender<?= $key + 1 ?>">
                                    <th><?php echo $key + 1; ?> </th>
                                    <td><?= $this->Html->link($amendment['proofs'][$i]->file, substr($amendment['proofs'][$i]->dir, 8) . '/' . $amendment['proofs'][$i]->file, ['fullBase' => true, 'class' => 'btn btn-info']) . " &nbsp;" ?>
                                    </td>
                                </tr>
                    <?php
                            }
                    ...
                    <tr>
                        <td colspan="2">
                            <h5>10.2.3 Name and contact details of Ethics committee(s) <small>where necessary, Click
                                    button to add more </small></h5>
                        </td>
                    </tr>
                    ...
                    ?>
                                <tr class="amender amender<?= $key + 1 ?>">
                                    <th><?php echo $key + 1; ?> <label>Ethics Committee Name <span class="sterix">*</span></label>
                                    </th>
            ...
            <div id="tabs-11">
                <table class="table table-condensed vertical-table">
                    ...
                    <tr>
                        <td colspan="2">
                            <h5> 11.2 If the trial is to be conducted in Zimbabwe and not in the host country of the
                                applicant / sponsor, provide an explanation <i class="sterix fa fa-asterisk" aria-hidden="true"></i></h5>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2">
                            <h5> 11.3 Name other Regulatory Authorities to
                                which applications to do this trial have been submitted, but approval has not yet been
                                granted. Include date(s)
                                of application: </h5>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2">
                            <h5> 11.4 Name other Regulatory Authorities
                                which have approved this trial, date(s) of approval and number of sites per country.
                            </h5>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2">
                            <h5> 11.5 if applicable, name other Regulatory Authorities or Ethics Committees which have
                                rejected this trial and give reasons for rejection:</h5>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2">
                            <h5> 11.6 If applicable, details of and reasons for this trial having been halted at any
                                stage by other Regulatory Authorities:</h5>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2">
                            <h5> 11.7 Recording of effects, give a description of the methods of recordings and times of
                                recordings</h5>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2">
                            <h5> 11.8 State the Clinical and laboratory tests, pharmacokinetic analysis etc that are to
                                be carried out</h5>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2">
                            <h5> 11.9 State the method of recording adverse reactions and provisions for dealing with
                                the same and other complications <i class="sterix fa fa-asterisk" aria-hidden="true"></i></h5>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2">
                            <h5> 11.10 State the procedure for keeping participants lists and participant records for
                                each participant taking part in the trial.
                                (Attachment or records for identification of persons) <i class="sterix fa fa-asterisk" aria-hidden="true"></i></h5>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2">
                            <h5><b> 11.11 State where will trial code will be kept and how it can it be broken in case
                                    of an emergency <i class="sterix fa fa-asterisk" aria-hidden="true"></i></b></h5>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2">
                            <h5> 11.12 State measures to be implemented to ensure the safe handling of medicines and
                                promote and control compliances with prescribed instructions <i class="sterix fa fa-asterisk" aria-hidden="true"></i></h5>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2">
                            <h5> 11.13 Evaluation of results, state the description of methodology (eg statistical
                                methods) <i class="sterix fa fa-asterisk" aria-hidden="true"></i></h5>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2">
                            <h5> 11.14 State how the persons or owners of animals are to be informed about the trial <i class="sterix fa fa-asterisk" aria-hidden="true"></i></h5>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2">
                            <h5> 11.15 State how the staff involved are to be informed about the way the trial is to be
                                conducted and about the procedures for medicine usage and administration and what to do
                                in an emergency <i class="sterix fa fa-asterisk" aria-hidden="true"></i></h5>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2">
                            <h5> Particulars of the animals that will take part in the clinical Trial <small>Kind and
                                    breed of animal
                                    Age of animal if known
                                    Names and Addresses of owners of animals</small></h5>
                        </td>
                    </tr>
                    <tr>
            ...
            <div id="tabs-12">
                <table class="table table-condensed vertical-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <label>
                                <?= ($application->applicant_covering_letter) ? $checked : $nChecked; ?> Covering Letter
                                <i class="sterix fa fa-asterisk" aria-hidden="true"></i>
                            </label>
                            <br>
                            <?php
                    ...
                    foreach ($application['amendments'] as $key => $amendment) {
                        if ($amendment['submitted'] == 2 && !empty($amendment['cover_letters'])) {
                            for ($i = 0; $i <= count($amendment['cover_letters']) - 1; $i++) { ?>
                                <tr class="amender amender<?= $key + 1 ?>">
                                    <th><?php echo $key + 1; ?> </th>
                                    <td><?= $this->Html->link($amendment['cover_letters'][$i]->file, substr($amendment['cover_letters'][$i]->dir, 8) . '/' . $amendment['cover_letters'][$i]->file, ['fullBase' => true, 'class' => 'btn btn-info']) . " &nbsp;" ?>
                                    </td>
                                </tr>
                    <?php
                            }
                    ...
                    <tr>
                        ...
                        <td>
                            <label>
                                <?= ($application->applicant_fees) ? $checked : $nChecked; ?> Practicing License for
                                principal investigator or co-investigator <i class="sterix fa fa-asterisk" aria-hidden="true"></i>
                            </label>
                            <br>
                            <?php
                    ...
                    foreach ($application['amendments'] as $key => $amendment) {
                        if ($amendment['submitted'] == 2 && !empty($amendment['fees'])) {
                            for ($i = 0; $i <= count($amendment['fees']) - 1; $i++) { ?>
                                <tr class="amender amender<?= $key + 1 ?>">
                                    <th><?php echo $key + 1; ?> </th>
                                    <td><?= $this->Html->link($amendment['fees'][$i]->file, substr($amendment['fees'][$i]->dir, 8) . '/' . $amendment['fees'][$i]->file, ['fullBase' => true, 'class' => 'btn btn-info']) . " &nbsp;" ?>
                                    </td>
                                </tr>
                    <?php
                            }
                    ...
                    <tr>
                        ...
                        <td>
                            <label>
                                <?= ($application->applicant_mc10) ? $checked : $nChecked; ?> Pharmacy License or
                                Certificate </i>
                            </label>
                            <br>
                            <?php
                    ...
                    foreach ($application['amendments'] as $key => $amendment) {
                        if ($amendment['submitted'] == 2 && !empty($amendment['legal_forms'])) {
                            for ($i = 0; $i <= count($amendment['legal_forms']) - 1; $i++) { ?>
                                <tr class="amender amender<?= $key + 1 ?>">
                                    <th><?php echo $key + 1; ?> </th>
                                    <td><?= $this->Html->link($amendment['legal_forms'][$i]->file, substr($amendment['legal_forms'][$i]->dir, 8) . '/' . $amendment['legal_forms'][$i]->file, ['fullBase' => true, 'class' => 'btn btn-info']) . " &nbsp;" ?>
                                    </td>
                                </tr>
                    <?php
                            }
                    ...
                    <tr>
                        ...
                        <td>
                            <label>
                                <?= ($application->applicant_protocol) ? $checked : $nChecked; ?> Protocol (including
                                relevant questionnaires, etc.) <i class="sterix fa fa-asterisk" aria-hidden="true"></i>
                            </label>
                            <br>
                            <?php
                    ...
                    foreach ($application['amendments'] as $key => $amendment) {
                        if ($amendment['submitted'] == 2 && !empty($amendment['protocols'])) {
                            for ($i = 0; $i <= count($amendment['protocols']) - 1; $i++) { ?>
                                <tr class="amender amender<?= $key + 1 ?>">
                                    <th><?php echo $key + 1; ?> </th>
                                    <td><?= $this->Html->link($amendment['protocols'][$i]->file, substr($amendment['protocols'][$i]->dir, 8) . '/' . $amendment['protocols'][$i]->file, ['fullBase' => true, 'class' => 'btn btn-info']) . " &nbsp;" ?>
                                    </td>
                                </tr>
                    <?php
                            }
                    ...
                    <tr>
                        ...
                        <td>
                            <label>
                                <?= ($application->applicant_patient_information) ? $checked : $nChecked; ?> Patient
                                information leaflet(s) and informed consent(s) including vernacular versions and English
                                back translations <i class="sterix fa fa-asterisk" aria-hidden="true"></i>
                            </label>
                            <br>
                            <?php
                    ...
                    foreach ($application['amendments'] as $key => $amendment) {
                        if ($amendment['submitted'] == 2 && !empty($amendment['leaflets'])) {
                            for ($i = 0; $i <= count($amendment['leaflets']) - 1; $i++) { ?>
                                <tr class="amender amender<?= $key + 1 ?>">
                                    <th><?php echo $key + 1; ?> </th>
                                    <td><?= $this->Html->link($amendment['leaflets'][$i]->file, substr($amendment['leaflets'][$i]->dir, 8) . '/' . $amendment['leaflets'][$i]->file, ['fullBase' => true, 'class' => 'btn btn-info']) . " &nbsp;" ?>
                                    </td>
                                </tr>
                    <?php
                            }
                    ...
                    <tr>
                        ...
                        <td>
                            <label>
                                <?= ($application->applicant_investigators_brochure) ? $checked : $nChecked; ?>
                    ...
                    foreach ($application['amendments'] as $key => $amendment) {
                        if ($amendment['submitted'] == 2 && !empty($amendment['brochures'])) {
                            for ($i = 0; $i <= count($amendment['brochures']) - 1; $i++) { ?>
                                <tr class="amender amender<?= $key + 1 ?>">
                                    <th><?php echo $key + 1; ?> </th>
                                    <td><?= $this->Html->link($amendment['brochures'][$i]->file, substr($amendment['brochures'][$i]->dir, 8) . '/' . $amendment['brochures'][$i]->file, ['fullBase' => true, 'class' => 'btn btn-info']) . " &nbsp;" ?>
                                    </td>
                                </tr>
                    <?php
                            }
                    ...
                    <tr>
                        ...
                        <td>
                            <label>
                                <?= ($application->applicant_investigators_cv) ? $checked : $nChecked; ?> Investigator's
                                CV(s) in required format <i class="sterix fa fa-asterisk" aria-hidden="true"></i>
                            </label>
                            <br>
                            <?php
                    ...
                    foreach ($application['amendments'] as $key => $amendment) {
                        if ($amendment['submitted'] == 2 && !empty($amendment['investigator_cvs'])) {
                            for ($i = 0; $i <= count($amendment['investigator_cvs']) - 1; $i++) { ?>
                                <tr class="amender amender<?= $key + 1 ?>">
                                    <th><?php echo $key + 1; ?> </th>
                                    <td><?= $this->Html->link($amendment['investigator_cvs'][$i]->file, substr($amendment['investigator_cvs'][$i]->dir, 8) . '/' . $amendment['investigator_cvs'][$i]->file, ['fullBase' => true, 'class' => 'btn btn-info']) . " &nbsp;" ?>
                                    </td>
                                </tr>
                    <?php
                            }
                    ...
                    <tr>
                        ...
                        <td>
                            <label>
                                <?= ($application->applicant_signed_declaration) ? $checked : $nChecked; ?> Signed
                                declaration(s) by investigator(s) to comply with GCP <i class="sterix fa fa-asterisk" aria-hidden="true"></i>
                            </label>
                            <br>
                            <?php
                    ...
                    foreach ($application['amendments'] as $key => $amendment) {
                        if ($amendment['submitted'] == 2 && !empty($amendment['declarations'])) {
                            for ($i = 0; $i <= count($amendment['declarations']) - 1; $i++) { ?>
                                <tr class="amender amender<?= $key + 1 ?>">
                                    <th><?php echo $key + 1; ?> </th>
                                    <td><?= $this->Html->link($amendment['declarations'][$i]->file, substr($amendment['declarations'][$i]->dir, 8) . '/' . $amendment['declarations'][$i]->file, ['fullBase' => true, 'class' => 'btn btn-info']) . " &nbsp;" ?>
                                    </td>
                                </tr>
                    <?php
                            }
                    ...
                    <tr>
                        ...
                        <td>
                            <label>
                                <?= ($application->applicant_study_monitors) ? $checked : $nChecked; ?> CV(s) and signed
                                declaration(s) by study coordinator and/or monitor
                            </label>
                            <br>
                            <?php
                    ...
                    foreach ($application['amendments'] as $key => $amendment) {
                        if ($amendment['submitted'] == 2 && !empty($amendment['study_monitors'])) {
                            for ($i = 0; $i <= count($amendment['study_monitors']) - 1; $i++) { ?>
                                <tr class="amender amender<?= $key + 1 ?>">
                                    <th><?php echo $key + 1; ?> </th>
                                    <td><?= $this->Html->link($amendment['study_monitors'][$i]->file, substr($amendment['study_monitors'][$i]->dir, 8) . '/' . $amendment['study_monitors'][$i]->file, ['fullBase' => true, 'class' => 'btn btn-info']) . " &nbsp;" ?>
                                    </td>
                                </tr>
                    <?php
                            }
                    ...
                    <tr>
                        ...
                        <td>
                            <label>
                                <?= ($application->applicant_monitoring_plans) ? $checked : $nChecked; ?> Monitoring
                                plan by sponsor/PI/monitor throughout study <i class="sterix fa fa-asterisk" aria-hidden="true"></i>
                            </label>
                            <br>
                            <?php
                    ...
                    foreach ($application['amendments'] as $key => $amendment) {
                        if ($amendment['submitted'] == 2 && !empty($amendment['monitoring_plans'])) {
                            for ($i = 0; $i <= count($amendment['monitoring_plans']) - 1; $i++) { ?>
                                <tr class="amender amender<?= $key + 1 ?>">
                                    <th><?php echo $key + 1; ?> </th>
                                    <td><?= $this->Html->link($amendment['monitoring_plans'][$i]->file, substr($amendment['monitoring_plans'][$i]->dir, 8) . '/' . $amendment['monitoring_plans'][$i]->file, ['fullBase' => true, 'class' => 'btn btn-info']) . " &nbsp;" ?>
                                    </td>
                                </tr>
                    <?php
                            }
                    ...
                    <tr>
                        ...
                        <td>
                            <label>
                                <?= ($application->applicant_pi_declaration) ? $checked : $nChecked; ?> Signed
                                Declaration by sponsor and national PI to comply with GCP <i class="sterix fa fa-asterisk" aria-hidden="true"></i>
                            </label>
                            <br>
                            <?php
                    ...
                    foreach ($application['amendments'] as $key => $amendment) {
                        if ($amendment['submitted'] == 2 && !empty($amendment['pi_declarations'])) {
                            for ($i = 0; $i <= count($amendment['pi_declarations']) - 1; $i++) { ?>
                                <tr class="amender amender<?= $key + 1 ?>">
                                    <th><?php echo $key + 1; ?> </th>
                                    <td><?= $this->Html->link($amendment['pi_declarations'][$i]->file, substr($amendment['pi_declarations'][$i]->dir, 8) . '/' . $amendment['pi_declarations'][$i]->file, ['fullBase' => true, 'class' => 'btn btn-info']) . " &nbsp;" ?>
                                    </td>
                                </tr>
                    <?php
                            }
                    ...
                    <tr>
                        ...
                        <td>
                            <label>
                                <?= ($application->applicant_study_sponsorship) ? $checked : $nChecked; ?> Signed
                                financial declaration by sponsor and national PI for study sponsorship
                            </label>
                            <br>
                            <?php
                    ...
                    foreach ($application['amendments'] as $key => $amendment) {
                        if ($amendment['submitted'] == 2 && !empty($amendment['study_sponsorships'])) {
                            for ($i = 0; $i <= count($amendment['study_sponsorships']) - 1; $i++) { ?>
                                <tr class="amender amender<?= $key + 1 ?>">
                                    <th><?php echo $key + 1; ?> </th>
                                    <td><?= $this->Html->link($amendment['study_sponsorships'][$i]->file, substr($amendment['study_sponsorships'][$i]->dir, 8) . '/' . $amendment['study_sponsorships'][$i]->file, ['fullBase' => true, 'class' => 'btn btn-info']) . " &nbsp;" ?>
                                    </td>
                                </tr>
                    <?php
                            }
                    ...
                    <tr>
                        ...
                        <td>
                            <label>
                                <?= ($application->applicant_pharmacy_plan) ? $checked : $nChecked; ?> Pharmacy plan for
                                local trial site
                            </label>
                            <br>
                            <?php
                    ...
                    foreach ($application['amendments'] as $key => $amendment) {
                        if ($amendment['submitted'] == 2 && !empty($amendment['pharmacy_plans'])) {
                            for ($i = 0; $i <= count($amendment['pharmacy_plans']) - 1; $i++) { ?>
                                <tr class="amender amender<?= $key + 1 ?>">
                                    <th><?php echo $key + 1; ?> </th>
                                    <td><?= $this->Html->link($amendment['pharmacy_plans'][$i]->file, substr($amendment['pharmacy_plans'][$i]->dir, 8) . '/' . $amendment['pharmacy_plans'][$i]->file, ['fullBase' => true, 'class' => 'btn btn-info']) . " &nbsp;" ?>
                                    </td>
                                </tr>
                    <?php
                            }
                    ...
                    <tr>
                        ...
                        <td>
                            <label>
                                <?= ($application->applicant_pharmacy_license) ? $checked : $nChecked; ?> MCAZ Pharmacy
                    ...
                    foreach ($application['amendments'] as $key => $amendment) {
                        if ($amendment['submitted'] == 2 && !empty($amendment['pharmacy_licenses'])) {
                            for ($i = 0; $i <= count($amendment['pharmacy_licenses']) - 1; $i++) { ?>
                                <tr class="amender amender<?= $key + 1 ?>">
                                    <th><?php echo $key + 1; ?> </th>
                                    <td><?= $this->Html->link($amendment['pharmacy_licenses'][$i]->file, substr($amendment['pharmacy_licenses'][$i]->dir, 8) . '/' . $amendment['pharmacy_licenses'][$i]->file, ['fullBase' => true, 'class' => 'btn btn-info']) . " &nbsp;" ?>
                                    </td>
                                </tr>
                    <?php
                            }
                    ...
                    <tr>
                        ...
                        <td>
                            <label>
                                <?= ($application->applicant_study_medicines) ? $checked : $nChecked; ?> Details of
                                study medicines and concomitant medicines
                            </label>
                            <br>
                            <?php
                    ...
                    foreach ($application['amendments'] as $key => $amendment) {
                        if ($amendment['submitted'] == 2 && !empty($amendment['study_medicines'])) {
                            for ($i = 0; $i <= count($amendment['study_medicines']) - 1; $i++) { ?>
                                <tr class="amender amender<?= $key + 1 ?>">
                                    <th><?php echo $key + 1; ?> </th>
                                    <td><?= $this->Html->link($amendment['study_medicines'][$i]->file, substr($amendment['study_medicines'][$i]->dir, 8) . '/' . $amendment['study_medicines'][$i]->file, ['fullBase' => true, 'class' => 'btn btn-info']) . " &nbsp;" ?>
                                    </td>
                                </tr>
                    <?php
                            }
                    ...
                    <tr>
                        ...
                        <td>
                            <label>
                                <?= ($application->applicant_insurance_certificate) ? $checked : $nChecked; ?> Proof of
                                participants' insurance certificate
                            </label>
                            <br>
                            <?php
                    ...
                    foreach ($application['amendments'] as $key => $amendment) {
                        if ($amendment['submitted'] == 2 && !empty($amendment['insurance_certificates'])) {
                            for ($i = 0; $i <= count($amendment['insurance_certificates']) - 1; $i++) { ?>
                                <tr class="amender amender<?= $key + 1 ?>">
                                    <th><?php echo $key + 1; ?> </th>
                                    <td><?= $this->Html->link($amendment['insurance_certificates'][$i]->file, substr($amendment['insurance_certificates'][$i]->dir, 8) . '/' . $amendment['insurance_certificates'][$i]->file, ['fullBase' => true, 'class' => 'btn btn-info']) . " &nbsp;" ?>
                                    </td>
                                </tr>
                    <?php
                            }
                    ...
                    <tr>
                        ...
                        <td>
                            <label>
                                <?= ($application->applicant_generic_insurance) ? $checked : $nChecked; ?> Letter
                                endorsing generic insurance certificate
                            </label>
                            <br>
                            <?php
                    ...
                    foreach ($application['amendments'] as $key => $amendment) {
                        if ($amendment['submitted'] == 2 && !empty($amendment['generic_insurances'])) {
                            for ($i = 0; $i <= count($amendment['generic_insurances']) - 1; $i++) { ?>
                                <tr class="amender amender<?= $key + 1 ?>">
                                    <th><?php echo $key + 1; ?> </th>
                                    <td><?= $this->Html->link($amendment['generic_insurances'][$i]->file, substr($amendment['generic_insurances'][$i]->dir, 8) . '/' . $amendment['generic_insurances'][$i]->file, ['fullBase' => true, 'class' => 'btn btn-info']) . " &nbsp;" ?>
                                    </td>
                                </tr>
                    <?php
                            }
                    ...
                    <tr>
                        ...
                        <td>
                            <label>
                                <?= ($application->applicant_ethics_approval) ? $checked : $nChecked; ?> Ethics
                                approval, in country of origin and local MRCZ approval
                            </label>
                            <br>
                            <?php
                    ...
                    foreach ($application['amendments'] as $key => $amendment) {
                        if ($amendment['submitted'] == 2 && !empty($amendment['ethics_approvals'])) {
                            for ($i = 0; $i <= count($amendment['ethics_approvals']) - 1; $i++) { ?>
                                <tr class="amender amender<?= $key + 1 ?>">
                                    <th><?php echo $key + 1; ?> </th>
                                    <td><?= $this->Html->link($amendment['ethics_approvals'][$i]->file, substr($amendment['ethics_approvals'][$i]->dir, 8) . '/' . $amendment['ethics_approvals'][$i]->file, ['fullBase' => true, 'class' => 'btn btn-info']) . " &nbsp;" ?>
                                    </td>
                                </tr>
                    <?php
                            }
                    ...
                    <tr>
                        ...
                        <td>
                            <label>
                                <?= ($application->applicant_ethics_letter) ? $checked : $nChecked; ?> Copy of letter
                    ...
                    foreach ($application['amendments'] as $key => $amendment) {
                        if ($amendment['submitted'] == 2 && !empty($amendment['ethics_letters'])) {
                            for ($i = 0; $i <= count($amendment['ethics_letters']) - 1; $i++) { ?>
                                <tr class="amender amender<?= $key + 1 ?>">
                                    <th><?php echo $key + 1; ?> </th>
                                    <td><?= $this->Html->link($amendment['ethics_letters'][$i]->file, substr($amendment['ethics_letters'][$i]->dir, 8) . '/' . $amendment['ethics_letters'][$i]->file, ['fullBase' => true, 'class' => 'btn btn-info']) . " &nbsp;" ?>
                                    </td>
                                </tr>
                    <?php
                            }
                    ...
                    <tr>
                        ...
                        <td>
                            <label>
                                <?= ($application->applicant_country_approvals) ? $checked : $nChecked; ?> Proof of
                                approval of study by the National Regulatory Authority in country of origin
                            </label>
                            <br>
                            <?php
                    ...
                    foreach ($application['amendments'] as $key => $amendment) {
                        if ($amendment['submitted'] == 2 && !empty($amendment['country_approvals'])) {
                            for ($i = 0; $i <= count($amendment['country_approvals']) - 1; $i++) { ?>
                                <tr class="amender amender<?= $key + 1 ?>">
                                    <th><?php echo $key + 1; ?> </th>
                                    <td><?= $this->Html->link($amendment['country_approvals'][$i]->file, substr($amendment['country_approvals'][$i]->dir, 8) . '/' . $amendment['country_approvals'][$i]->file, ['fullBase' => true, 'class' => 'btn btn-info']) . " &nbsp;" ?>
                                    </td>
                                </tr>
                    <?php
                            }
                    ...
                    <tr>
                        ...
                        <td>
                            <label>
                                <?= ($application->applicant_advertisments) ? $checked : $nChecked; ?> Copy/ies of
                    ...
                    foreach ($application['amendments'] as $key => $amendment) {
                        if ($amendment['submitted'] == 2 && !empty($amendment['advertisments'])) {
                            for ($i = 0; $i <= count($amendment['advertisments']) - 1; $i++) { ?>
                                <tr class="amender amender<?= $key + 1 ?>">
                                    <th><?php echo $key + 1; ?> </th>
                                    <td><?= $this->Html->link($amendment['advertisments'][$i]->file, substr($amendment['advertisments'][$i]->dir, 8) . '/' . $amendment['advertisments'][$i]->file, ['fullBase' => true, 'class' => 'btn btn-info']) . " &nbsp;" ?>
                                    </td>
                                </tr>
                    <?php
                            }
                    ...
                    <tr>
                        ...
                        <td>
                            <label>
                                <?= ($application->applicant_safety_monitoring) ? $checked : $nChecked; ?> Proof of
                                Provision of Data Safety Monitoring Board (DSMB/DMC) Committee
                            </label>
                            <br>
                            <?php
                    ...
                    foreach ($application['amendments'] as $key => $amendment) {
                        if ($amendment['submitted'] == 2 && !empty($amendment['safety_monitors'])) {
                            for ($i = 0; $i <= count($amendment['safety_monitors']) - 1; $i++) { ?>
                                <tr class="amender amender<?= $key + 1 ?>">
                                    <th><?php echo $key + 1; ?> </th>
                                    <td><?= $this->Html->link($amendment['safety_monitors'][$i]->file, substr($amendment['safety_monitors'][$i]->dir, 8) . '/' . $amendment['safety_monitors'][$i]->file, ['fullBase' => true, 'class' => 'btn btn-info']) . " &nbsp;" ?>
                                    </td>
                                </tr>
                    <?php
                            }
                    ...
                    <tr>
                        ...
                        <td>
                            <label>
                                <?= ($application->applicant_biological_products) ? $checked : $nChecked; ?> Proof of
                                application to the local Bio Safety Board for biological products e.g. vaccines
                            </label>
                            <br>
                            <?php
                    ...
                    foreach ($application['amendments'] as $key => $amendment) {
                        if ($amendment['submitted'] == 2 && !empty($amendment['biological_products'])) {
                            for ($i = 0; $i <= count($amendment['biological_products']) - 1; $i++) { ?>
                                <tr class="amender amender<?= $key + 1 ?>">
                                    <th><?php echo $key + 1; ?> </th>
                                    <td><?= $this->Html->link($amendment['biological_products'][$i]->file, substr($amendment['biological_products'][$i]->dir, 8) . '/' . $amendment['biological_products'][$i]->file, ['fullBase' => true, 'class' => 'btn btn-info']) . " &nbsp;" ?>
                                    </td>
                                </tr>
                    <?php
                            }
                    ...
                    <tr>
                        ...
                        <td>
                            <label>
                                <?= ($application->applicant_dossier) ? $checked : $nChecked; ?> Pharmaceutical dossier
                                for a new investigational drug (NID) product including stability data
                                ...
                                manufactured as \'trial batches\' for the study then a pharmaceutical dossier is also
                                required.
                            </label>
                            <br>
                            <?php
                    ...
                    foreach ($application['amendments'] as $key => $amendment) {
                        if ($amendment['submitted'] == 2 && !empty($amendment['dossiers'])) {
                            for ($i = 0; $i <= count($amendment['dossiers']) - 1; $i++) { ?>
                                <tr class="amender amender<?= $key + 1 ?>">
                                    <th><?php echo $key + 1; ?> </th>
                                    <td><?= $this->Html->link($amendment['dossiers'][$i]->file, substr($amendment['dossiers'][$i]->dir, 8) . '/' . $amendment['dossiers'][$i]->file, ['fullBase' => true, 'class' => 'btn btn-info']) . " &nbsp;" ?>
                                    </td>
                                </tr>
                    <?php
                            }
                    ...
                    foreach ($application['amendments'] as $key => $amendment) {
                        if ($amendment['submitted'] == 2 && !empty($amendment['mc10_forms'])) {
                            for ($i = 0; $i <= count($amendment['mc10_forms']) - 1; $i++) { ?>
                                <tr class="amender amender<?= $key + 1 ?>">
                                    <th><?php echo $key + 1; ?> </th>
                                    <td><?= $this->Html->link($amendment['mc10_forms'][$i]->file, substr($amendment['mc10_forms'][$i]->dir, 8) . '/' . $amendment['mc10_forms'][$i]->file, ['fullBase' => true, 'class' => 'btn btn-info']) . " &nbsp;" ?>
                                    </td>
                                </tr>
                    <?php
                            }
