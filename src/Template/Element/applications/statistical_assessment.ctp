...
if (!in_array($prefix, ['director_general', 'admin']) and count(array_filter(Hash::extract($application->statisticals, '{n}.chosen'), 'is_numeric')) < 1) {
                        ...
                        <td colspan="3">
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <?php
                                    echo $this->Form->control('statisticals.' . $ekey . '.file', ['type' => 'file', 'label' => false, 'escape' => false, 'templates' => 'table_form']);
                                    ?>
                                </div>
                            </div>
                        </td>
                        ...
                        <td colspan="3">
                            <div class="row">
                                <div class="col-xs-6">
                                    ...
                                    echo $this->Form->control('statisticals.' . $ekey . '.signature', ['type' => 'hidden', 'value' => 1, 'templates' => 'table_form']);
                                    ?>
                                </div>
                                <div class="col-xs-4">
                                    <?php
