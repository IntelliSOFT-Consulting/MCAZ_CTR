...
<div class="row">
    <div class="col-xs-4">
        <div class="row">
            <div class="col-xs-12">
                ...
                ?>
                <div class="thumbnail">
                    <p class="topper"><small><em class="text-success">assigned on: <?= $evaluator['created'] ?> by
                                <?= $evaluator->user->name ?></em></small></p>
                    <?php
                    ...
                    <form>
                        <div class="form-group">
                            ...
                            <p class="form-control-static">
                                <?= $this->cell('Signature::index', [$evaluator->assigned_to]) ?></p>
                        </div>
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <?php
                            ...
                            echo $this->Form->control('assign_evaluators.100.assigned_to', [
                                'type' => 'select',
                                'options' => $internal_evaluators, 'empty' => false, 'escape' => false, 'templates' => 'app_form'
                            ]);
    ...
    <div class="col-xs-4" style="min-height: 450px; border-left: 1px solid #eee; border-right: 1px solid #eee;">
        <div class="row">
            <div class="col-xs-12">
                <h4 class="text-center">Manager</h4>
                <?php foreach ($application->assign_evaluators as $evaluator) {
                    if ($evaluator->category === 'self') {
                ?>
                <div class="thumbnail">
                    <p class="topper"><small><em class="text-success">assigned on: <?= $evaluator['created'] ?> by
                                <?= $evaluator->user->name ?></em></small></p>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <?php
                            ...
                            echo $this->Form->control('assign_evaluators.100.id', ['type' => 'hidden', 'escape' => false, 'templates' => 'table_form']);
                            echo $this->Form->control('assign_evaluators.100.user_id', ['type' => 'hidden', 'value' => $this->request->session()->read('Auth.User.id'), 'templates' => 'table_form']);
                            echo $this->Form->control('assign_evaluators.100.category', ['type' => 'hidden', 'value' => 'self', 'templates' => 'table_form']);
                            echo $this->Form->control('assign_evaluators.100.assigned_to', [
                                'type' => 'hidden', 'value' => $this->request->session()->read('Auth.User.id'), 'templates' => 'app_form'
                            ]);
                            echo $this->Form->control('assign_evaluators.100.user_message', ['label' => '<label class="text-success">Reminder Note</label>', 'escape' => false, 'templates' => 'textarea_form']);
                            ?>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-offset-4 col-sm-8">
                        <button type="submit" class="btn btn-success active" id="registerUser"><i class="fa fa-user"
                                aria-hidden="true"></i> Assign Self</button>
                ...
                <div class="thumbnail">
                    ...
                    <form>
                        <div class="form-group">
                            ...
                            <p class="form-control-static"><?= $all_evaluators->toArray()[$evaluator->assigned_to] ?>
                            </p>
                        </div>
                        <div class="form-group">
                            <label>User Message</label>
