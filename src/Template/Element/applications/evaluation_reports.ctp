    ...
    foreach ($evaluations as $evaluation) {
      if ($evaluation->evaluation_type == 'Initial') {
        ...
        <div class="thumbnail amend-form">
          ...
          if (
            $this->request->params['_ext'] != 'pdf' and ($evaluation->user_id == $this->request->session()->read('Auth.User.id'))
          ...
          if (
            ...
            echo $this->Form->postLink(
              '<span class="label label-success active">Approve the evaluation?</span>',
          ...
          if (
            $this->request->params['_ext'] != 'pdf' and !empty($evaluation->chosen)
              ...
              <tbody>
                    ...
                    <div class="row">
                      <div class="col-xs-4">
                        <div class="entry">
                          ...
                          <?php
                          for ($i = 0; $i < $evec; $i++) {
                            $a = ($eved[$i]['vulnerable_pregnant']) ? $checked : $nChecked;
                            $a .= ' Pregnant women <br>';
                        ...
                        <div class="entry">
                          ...
                          <?php
                          for ($i = 0; $i < $evec; $i++) {
                            $a = ($eved[$i]['vulnerable_adolescent']) ? $checked : $nChecked;
                            $a .= ' Adolescents <br>';
                        ...
                        <div class="entry">
                          ...
                          <?php
                          for ($i = 0; $i < $evec; $i++) {
                            $a = ($eved[$i]['vulnerable_children']) ? $checked : $nChecked;
                            $a .= ' Children <br>';
                      ...
                      <div class="col-xs-4">
                        <div class="entry">
                          ...
                          <?php
                          for ($i = 0; $i < $evec; $i++) {
                            $a = ($eved[$i]['vulnerable_elderly']) ? $checked : $nChecked;
                            $a .= ' Elderly <br>';
                        ...
                        <div class="entry">
                          ...
                          <?php
                          for ($i = 0; $i < $evec; $i++) {
                            $a = ($eved[$i]['vulnerable_refugees']) ? $checked : $nChecked;
                            $a .= ' Refugees <br>';
                        ...
                        <div class="entry">
                          ...
                          <?php
                          for ($i = 0; $i < $evec; $i++) {
                            $a = ($eved[$i]['vulnerable_unconscious']) ? $checked : $nChecked;
                            $a .= ' Those who cannot give consent (unconscious) <br>';
                      ...
                      <div class="col-xs-4">
                        <div class="entry">
                          ...
                          <?php
                          for ($i = 0; $i < $evec; $i++) {
                            $a = ($eved[$i]['vulnerable_prisoners']) ? $checked : $nChecked;
                            $a .= ' Prisoners <br>';
                        ...
                        <div class="entry">
                          ...
                          <?php
                          for ($i = 0; $i < $evec; $i++) {
                            $a = ($eved[$i]['vulnerable_mental']) ? $checked : $nChecked;
                            $a .= ' Persons with mental or Behavioural  Disorders <br>';
                        ...
                        <div class="entry">
                          ...
                          <?php
                          for ($i = 0; $i < $evec; $i++) {
                            $a = ($eved[$i]['vulnerable_others']) ? $checked : $nChecked;
                            $a .= ' Others <br>';
                ...
                <tr class="info">
                  <td colspan="3">
                    <div class="row">
                      <div class="col-xs-12">
                        <div class="evaluation-comments" data-type="wysihtml5" data-pk="<?= $evaluation->id ?>" data-url="<?= $this->Url->build(['controller' => 'Applications', 'action' => 'evaluationComment',  'prefix' => 'manager', $evaluation->id, '_ext' => 'json']); ?>" data-name="comment_vulnerable_population" data-title="Comments">
                          <p>
                ...
                <tr class="info">
                  <td colspan="3">
                    <div class="row">
                      <div class="col-xs-12">
                        <div class="evaluation-comments" data-type="wysihtml5" data-pk="<?= $evaluation->id ?>" data-url="<?= $this->Url->build(['controller' => 'Applications', 'action' => 'evaluationComment',  'prefix' => 'manager', $evaluation->id, '_ext' => 'json']); ?>" data-name="comment_scientific_issues" data-title="Comments">
                          <p>
                ...
                <tr class="info">
                  <td colspan="3">
                    <div class="row">
                      <div class="col-xs-12">
                        <div class="evaluation-comments" data-type="wysihtml5" data-pk="<?= $evaluation->id ?>" data-url="<?= $this->Url->build(['controller' => 'Applications', 'action' => 'evaluationComment',  'prefix' => 'manager', $evaluation->id, '_ext' => 'json']); ?>" data-name="comment_informed_consent" data-title="Comments">
                          <p>
                ...
                <tr class="info">
                  <td colspan="3">
                    <div class="row">
                      <div class="col-xs-12">
                        <div class="evaluation-comments" data-type="wysihtml5" data-pk="<?= $evaluation->id ?>" data-url="<?= $this->Url->build(['controller' => 'Applications', 'action' => 'evaluationComment',  'prefix' => 'manager', $evaluation->id, '_ext' => 'json']); ?>" data-name="comment_other_materials" data-title="Comments">
                          <p>
                ...
                <tr class="info">
                  <td colspan="3">
                    <div class="row">
                      <div class="col-xs-12">
                        <div class="evaluation-comments" data-type="wysihtml5" data-pk="<?= $evaluation->id ?>" data-url="<?= $this->Url->build(['controller' => 'Applications', 'action' => 'evaluationComment',  'prefix' => 'manager', $evaluation->id, '_ext' => 'json']); ?>" data-name="comment_clinical_trials" data-title="Comments">
                          <p>
                ...
                <tr class="info">
                  <td colspan="3">
                    <div class="row">
                      <div class="col-xs-12">
                        <div class="evaluation-comments" data-type="wysihtml5" data-pk="<?= $evaluation->id ?>" data-url="<?= $this->Url->build(['controller' => 'Applications', 'action' => 'evaluationComment',  'prefix' => 'manager', $evaluation->id, '_ext' => 'json']); ?>" data-name="comment_human_biological" data-title="Comments">
                          <p>
                ...
                <tr class="info">
                  <td colspan="3">
                    <div class="row">
                      <div class="col-xs-12">
                        <div class="evaluation-comments" data-type="wysihtml5" data-pk="<?= $evaluation->id ?>" data-url="<?= $this->Url->build(['controller' => 'Applications', 'action' => 'evaluationComment',  'prefix' => 'manager', $evaluation->id, '_ext' => 'json']); ?>" data-name="comment_recommendations" data-title="Comments">
                          <p>
