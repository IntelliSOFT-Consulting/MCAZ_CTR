...
<h3 class="page-header text-center"><?= $application->protocol_no ?></h3>
  ...
  <div class="row">
    ...
    <?php
      if($this->request->params['_ext'] != 'pdf') {
        echo $this->Html->link('<i class="fa fa-file-pdf-o" aria-hidden="true"></i> Download Stages ', ['controller' => 'Applications', 'action' => 'stages', '_ext' => 'pdf', $application->id, 'All'], ['escape' => false, 'class' => 'btn btn-info btn-sm']);              
      }
    ?>
    </div>
  </div>
