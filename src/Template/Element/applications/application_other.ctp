          ...
          <?php
            ...
            echo $this->Form->control('recording_method', array(
              'label' => '<h5> 11.9 State the method of recording adverse reactions and provisions for dealing with the same and other complications <i class="sterix fa fa-asterisk" aria-hidden="true"></i></h5>', 'escape' => false, 'templates' => 'textarea_form'
            ));
...
(Attachment or records for identification of persons) <i class="sterix fa fa-asterisk" aria-hidden="true"></i></h5>', 'escape' => false, 'templates' => 'textarea_form'
            ...
            echo $this->Form->control('trial_storage', array(
              'label' => '<h5><b> 11.12 State where will trial code will be kept and how it can it be broken in case of an emergency <i class="sterix fa fa-asterisk" aria-hidden="true"></i></b></h5>', 'escape' => false, 'templates' => 'textarea_form'
            ));

            echo $this->Form->control('measures_compliance', array(
              'label' => '<h5> 11.11 State measures to be implemented to ensure the safe handling of medicines and promote and control compliances with prescribed instructions <i class="sterix fa fa-asterisk" aria-hidden="true"></i></h5>', 'escape' => false, 'templates' => 'textarea_form'
            ));

            echo $this->Form->control('evalution_of_results', array(
              'label' => '<h5> 11.13 Evaluation of results, state the description of methodology (eg statistical methods) <i class="sterix fa fa-asterisk" aria-hidden="true"></i></h5>', 'escape' => false, 'templates' => 'textarea_form'
            ));

            echo $this->Form->control('inform_persons', array(
              'label' => '<h5> 11.14 State how the persons or owners of animals are to be informed about the trial <i class="sterix fa fa-asterisk" aria-hidden="true"></i></h5>', 'escape' => false, 'templates' => 'textarea_form'
            ));

            echo $this->Form->control('inform_staff', array(
              'label' => '<h5> 11.15  State how the staff involved are to be informed about the way the trial is to be conducted and about the procedures for medicine usage and administration and what to do in an emergency <i class="sterix fa fa-asterisk" aria-hidden="true"></i></h5>', 'escape' => false
            ));
