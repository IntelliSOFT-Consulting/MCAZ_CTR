      ...
      <div class="form-group"> 
          <div class="col-xs-12"> 
            ...
            <?php if($prefix == 'evaluator') { ?>
              ...
              <!-- <button type="submit" class="btn btn-success btn-sm" name="submitted" value="2" onclick="return confirm('Are you sure you wish to submit for manager review? You will not be able to edit it later.');"> <i class="fa fa-paper-plane" aria-hidden="true"></i> Submit <small>(for manager review)</small> </button> -->
