...
<button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#clinicalReview" aria-expanded="false"
...
<button class="btn btn-success" type="button" data-toggle="collapse" data-target="#qualityReview" aria-expanded="false"
    aria-controls="qualityReview">
    Quality Assessment.
</button>
<button class="btn btn-info" type="button" data-toggle="collapse" data-target="#statisticalReview" aria-expanded="false"
    aria-controls="statisticalReview">
