  ...
  <div class="row">
    <div class="col-xs-12">
      ...
      <hr>
    <?php
        echo $this->Html->link('<i class="fa fa-file-pdf-o" aria-hidden="true"></i> Download All ', ['controller' => 'Amendments', 'action' => 'evaluator', '_ext' => 'pdf', $amendment->id, 'All', ], ['escape' => false, 'class' => 'btn btn-info btn-sm']);
              ?>
    </div>
  </div>
