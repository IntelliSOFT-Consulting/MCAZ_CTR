...
?>
  ...
  <div class="row">
    <div class="col-xs-12">
      ...
      <hr>
    <?php
        echo $this->Html->link('<i class="fa fa-file-pdf-o" aria-hidden="true"></i> Download All ', ['controller' => 'Amendments', 'action' => 'communication', '_ext' => 'pdf', $amendment->id, 'All'], ['escape' => false, 'class' => 'btn btn-info btn-sm']);
              ?>
    </div>
  </div>
      ...
      <div class="row">
        <div class="col-xs-12">
          <?php foreach ($amendment->request_infos as $request_info) {  ?>
        ...
        <?php
        echo $this->Html->link('<i class="fa fa-file-pdf-o" aria-hidden="true"></i> Download PDF ', ['controller' => 'Amendments', 'action' => 'communication', '_ext' => 'pdf', $request_info->id], ['escape' => false, 'class' => 'btn btn-xs btn-success active topright']);
        ?>
         ...
         <?php echo $this->Form->create($amendment, ['type' => 'file','url' => ['action' => 'request-info'], 'class' => 'form-horizontal']); ?>
              <div class="row">
                <div class="col-xs-12">
                <?php
              ...
              <div class="form-group"> 
                  <div class="col-sm-12"> 
                    <button type="submit" class="btn btn-primary active" id="registerUser"><i class="fa fa-save" aria-hidden="true"></i> Request</button>
                  </div> 
              </div>
