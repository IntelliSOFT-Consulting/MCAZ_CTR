...
<div class="row">
  <div class="col-xs-12">
    ...
    <h4 class="text-warning">Director General Authorization</h4>
      <div class="row">
        <div class="col-xs-12">
          ...
          <?php
          echo $this->Html->link('<i class="fa fa-file-pdf-o" aria-hidden="true"></i> Download PDF ', ['controller' => 'Amendments', 'action' => 'committee', '_ext' => 'pdf', $dg_review->id], ['escape' => false, 'class' => 'btn btn-xs btn-success active topright']);
          ?>
    ...
    <?php foreach ($amendment->gcp_inspections as $gcp_inspection) { 
    ...
    <div class="ctr-groups  <?php if($gcp_inspection->user->group_id != 4) echo 'amend-form'; ?>">
        <p class="topper"><small><em class="text-success">created: <?= $gcp_inspection['created'] ?> by <?= ($gcp_inspection->user->group_id != 4) ? 'MCAZ' : $gcp_inspection->user->name; ?></em></small></p>
          <?php
          echo $this->Html->link('<i class="fa fa-file-pdf-o" aria-hidden="true"></i> Download PDF ', ['controller' => 'Amendments', 'action' => 'gcp', '_ext' => 'pdf', $gcp_inspection->id], ['escape' => false, 'class' => 'btn btn-xs btn-success active topright']);
          ?>
      <form class="form-horizontal">
        <div class="form-group">
    ...
    <div class="ctr-groups  <?php if($seventy_five->user->group_id != 4) echo 'amend-form'; ?>">
        ...
        <?php
        echo $this->Html->link('<i class="fa fa-file-pdf-o" aria-hidden="true"></i> Download PDF ', ['controller' => 'Amendments', 'action' => 'section75', '_ext' => 'pdf', $seventy_five->id], ['escape' => false, 'class' => 'btn btn-xs btn-success active topright']);
        ?>
      <form class="form-horizontal">
        <div class="form-group">
