      ...
      <form class="form-horizontal">
        ...
        if($prefix == 'manager') {
            echo    $this->Form->postLink(
                  ...
                  ['confirm' => 'Are you sure you want to delete this section 75 review for '.$amendment->protocol_no.'?', 'escape' => false,
    ...
    if(in_array("2", Hash::extract($application->application_stages, '{n}.stage_id'))) {
      echo $this->Form->create($amendment, ['type' => 'file','url' => ['action' => 'add-section75-review']]); ?>
        <div class="row">
          <div class="col-xs-12">
          <?php
                echo $this->Form->control('amendment_pr_id', ['type' => 'hidden', 'value' => $amendment->id, 'escape' => false, 'templates' => 'table_form']);
