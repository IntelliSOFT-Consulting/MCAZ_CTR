...
class ReviewsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'recommendation' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
        'notified' => ['type' => 'tinyinteger', 'length' => 2, 'unsigned' => false, 'null' => true, 'default' => '0', 'comment' => '', 'precision' => null],
        'accepted' => ['type' => 'string', 'fixed' => true, 'length' => 30, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2017-11-30 21:49:00',
            'modified' => '2017-11-30 21:49:00'
        ],
    ];
}
