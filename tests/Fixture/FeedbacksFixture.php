...
class FeedbacksFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'email' => ['type' => 'string', 'fixed' => true, 'length' => 50, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2017-10-31 18:31:29',
            'modified' => '2017-10-31 18:31:29'
        ],
    ];
}
