 ...
 *
 */
class ComplianceFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'site_name' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'site_function' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'valid_license' => ['type' => 'tinyinteger', 'length' => 4, 'unsigned' => false, 'null' => true, 'default' => '0', 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'site_function' => 'Lorem ipsum dolor sit amet',
                'valid_license' => 1,
                'comment' => 'Lorem ipsum dolor sit amet',
                'created_at' => '2022-10-11 10:45:17',
                'updated_at' => '2022-10-11 10:45:17'
            ],
        ];
        parent::init();
    }
