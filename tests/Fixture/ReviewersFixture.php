...
class ReviewersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'notified' => ['type' => 'boolean', 'length' => null, 'null' => true, 'default' => '0', 'comment' => '', 'precision' => null],
        'accepted' => ['type' => 'string', 'fixed' => true, 'length' => 30, 'null' => true, 'default' => '0', 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2017-11-30 21:48:49',
            'modified' => '2017-11-30 21:48:49'
        ],
    ];
}
