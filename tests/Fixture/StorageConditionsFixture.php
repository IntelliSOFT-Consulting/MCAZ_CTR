...
/**
 * StorageConditionsFixture
 *
 */
class StorageConditionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'pdrug_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'pos_thirty' => 1,
                'pos_forty' => 1,
                'created_at' => '2022-10-12 11:56:29',
                'updated_at' => '2022-10-12 11:56:29',
