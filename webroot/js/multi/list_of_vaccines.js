$(function() {
    ...
    function constructLOVTr(intId) {
        ...
        var trWrapper = '\
          <tr>\
            <td>{i2}</td>\
            <td><input class="form-control" name="aefi_list_of_vaccines[{i}][id]" id="adr-list-of-vaccines-{i}-id" type="hidden"> \
                <input class="form-control" name="aefi_list_of_vaccines[{i}][vaccine_name]" id="adr-list-of-vaccines-{i}-vaccine-name" type="text">  </td>\
            <td>\
                <input class="form-control datetime-field" name="aefi_list_of_vaccines[{i}][vaccination_date]" id="adr-list-of-vaccines-{i}-vaccination-date" type="text"> </td>\
            <td>\
                <input class="form-control" name="aefi_list_of_vaccines[{i}][dosage]" id="adr-list-of-vaccines-{i}-dosage" type="text">  </td>\
            <td>\
                <input class="form-control" name="aefi_list_of_vaccines[{i}][batch_number]" maxlength="255" id="adr-list-of-vaccines-{i}-batch-number" type="text"> </td>\
            <td>\
              <input class="form-control date-pick-field" name="aefi_list_of_vaccines[{i}][expiry_date]" id="adr-list-of-vaccines-{i}-expiry-date" type="text">   </td>\
            <td>\
    ...
    function constructLDTr(intId) {
        ...
        var trWrapper = '\
          <tr>\
            <td>{i2}</td>\
            <td><input class="form-control" name="aefi_list_of_diluents[{i}][id]" id="adr-list-of-diluents-{i}-id" type="hidden"> \
                <input class="form-control" name="aefi_list_of_diluents[{i}][diluent_name]" id="adr-list-of-diluents--{i}-diluent-name" type="text">  </td>\
            <td>\
                <input class="form-control datetime-field" name="aefi_list_of_diluents[{i}][diluent_date]" id="adr-list-of-diluents-{i}-diluent-date" type="text"> </td>\
            <td>\
                <input class="form-control" name="aefi_list_of_diluents[{i}][batch_number]" id="adr-list-of-diluents-{i}-batch-number" type="text">  </td>\
            <td>\
              <input class="form-control date-pick-field" name="aefi_list_of_diluents[{i}][expiry_date]" id="adr-list-of-diluents-{i}-expiry-date" type="text">   </td>\
            <td>\
